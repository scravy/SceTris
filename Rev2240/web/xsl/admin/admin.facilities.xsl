...
<xsl:template mode="content" match="vars:meta">
	...
	<xsl:if test="//form:quickEditBuildings">
	...
	<ul>
		<li><a href="{$module-path}/createDepartment">
			<xsl:value-of select="$mod-lang/createDepartment" /></a></li>
		<li><a href="{$module-path}/listDepartments">
			<xsl:value-of select="$mod-lang/listDepartments" /></a></li>
	</ul>
	<xsl:if test="//form:quickEditDepartments">
		<xsl:call-template name="form-builder">
