...
public class CustomReflectionTest {
	...
	public static class SampleController extends GenericWeavlet<Manager> {
		SampleController() throws WeavletInstantiationException {
			super(Manager.class, T("sample", SampleModule.class));
		}
	}
	...
	@Before
	public void _setup() throws WeavletInstantiationException {
