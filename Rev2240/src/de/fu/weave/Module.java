...
public interface Module<R extends RelationManager> {
    ...
    /**
     * Retrieve a File-Object for given path within the ServletPath
     * 
     * @param name
     * @return
     */
    ...
    /**
     * Return the mime type which is currently set by this module.
     * 
     * @return
     */
    String getMimeType();
    ...
    /**
     * Return the target of the redirect currently set.
     * 
     * @return null if none has been set, a {@see java.net.URL} if the target is an external link or
     *         a String, it the target is a local action.
     */
    Object getRedirect();

    /**
     * Return the Reflector for this module.
     * 
     * @return The Reflector which can be used to introspect this module.
     */
    ModuleReflector<? extends Module<? extends RelationManager>> getReflector();

    /**
     * Return the type which is currently set by this module.
     * 
    ...
    /**
     * Check whether this module currently holds binary data to be published.
     * 
     * @return Whether the module is having binary data or not.
     */
    boolean hasBinaryData();

    /**
     * Check whether a redirect has been set by this module or not.
     * 
    ...
    /**
     * Retrieves the user associated with the current modules session.
     * 
     * @return
     */
    User user();
