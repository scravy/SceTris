...
public class ConnectionManagerImpl implements ConnectionManager {
	...
	protected Logger $logger = Logger.getLogger(ConnectionManager.class);
	...
	@Override
	public ConnectionManagerImpl clone() {
		try {
			ConnectionManagerImpl $c = (ConnectionManagerImpl) super.clone();
			$c.connect();
			return $c;
		} catch (Exception $exc) {
			return null;
	...
	protected void finalize() throws Throwable {
		super.finalize();
		DriverManager.deregisterDriver(DriverManager.getDriver("jdbc:postgresql://localhost"));
	}
