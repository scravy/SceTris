/* CourseRequiresCourse.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"courseRequiresCourse\"", requiredSqlCols = {})
...
public class CourseRequiresCourse extends de.fu.weave.orm.GenericRelationship {
	...
	CourseRequiresCourse(RelationManager manager, java.sql.ResultSet result) throws de.fu.weave.orm.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			this.ref_course = result.getInt("\"course\"");
			this.ref_dependency = result.getInt("\"dependency\"");
	...
	@Override
	public CourseRequiresCourse create() throws de.fu.weave.orm.DatabaseException {
	...
	public CourseRequiresCourse setDependency(Course value) {
		...
		if (de.fu.weave.orm.GenericRelationManager.compareValues(ref_dependency, value._id) == 0) return this;
