/* CourseElementType.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"CourseElementType\"", requiredSqlCols = {"name"})
...
public class CourseElementType extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		public static final long serialVersionUID = 2123487L;
		...
		public Form setValues(CourseElementType $object) {
	 ...
	 */
	@Override
	public CourseElementType create() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration2
	 */
	public CourseElementType setName(String value) {
