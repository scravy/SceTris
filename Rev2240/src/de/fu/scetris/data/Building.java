/* Building.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"Building\"", requiredSqlCols = {"address"})
...
public class Building extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	 ...
	 */
	@Override
	public Building create() throws de.fu.weave.orm.DatabaseException {
...
@Override
	...
	public Building setAddress(String value) {
		...
		if (de.fu.weave.orm.GenericRelationManager.compareValues(_address, value) == 0) return this;
