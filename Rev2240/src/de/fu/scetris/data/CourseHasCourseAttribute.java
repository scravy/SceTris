/* CourseHasCourseAttribute.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"courseHasCourseAttribute\"", requiredSqlCols = {"value"})
...
public class CourseHasCourseAttribute extends de.fu.weave.orm.GenericRelationship {
	...
	CourseHasCourseAttribute(RelationManager manager, java.sql.ResultSet result) throws de.fu.weave.orm.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
	...
	CourseHasCourseAttribute(RelationManager manager, Course subject, CourseAttribute object, String _value) {
	...
	CourseHasCourseAttribute(RelationManager manager, boolean full, Course subject, CourseAttribute object, java.sql.Timestamp _time, String _value) {
		if (subject == null || object == null) {
			throw new IllegalArgumentException();
		}
		this.manager = manager;
	...
	@Override
	public CourseHasCourseAttribute create() throws de.fu.weave.orm.DatabaseException {
	...
	public void pushChanges() throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.weave.orm.OutdatedRecordException("\"scetris\".\"courseHasCourseAttribute\"" + '#' + id());
			}
			_timekey = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.weave.orm.DatabaseException(query, e);
	...
	@de.fu.weave.orm.annotation.Attribute(name = "attribute", use = "object", ref = CourseAttribute.class)
	 ...
	 * @since Iteration2
	 */
	public CourseHasCourseAttribute setCourse(Course value) {
	 ...
	 * @since Iteration2
	 */
	public CourseHasCourseAttribute setAttribute(CourseAttribute value) {
		if (manager.isNull(value)) {
	 ...
	 * @since Iteration2
	 */
	public CourseHasCourseAttribute setTime(java.sql.Timestamp value) {
		if (manager.isNull(value)) {
	 ...
	 * @since Iteration2
	 */
	public CourseHasCourseAttribute setValue(String value) {
		if (manager.isNull(value)) {
