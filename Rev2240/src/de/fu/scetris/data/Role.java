...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"Role\"", requiredSqlCols = {"name"})
...
public class Role extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		public static final long serialVersionUID = 4247136L;
		...
		public Form setValues(Role $object) {
	 ...
	 */
	@Override
	public Role create() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @return The object regarding RoleImpliesAttribute where this (the java-object you call objectsOfRoleImpliesAttribute on) is the subject.
	 */
	public java.util.List<Attribute> objectsOfRoleImpliesAttribute() throws de.fu.weave.orm.DatabaseException {
	 ...
	 */
	public java.util.List<RoleImpliesAttribute> whereSubjectOfRoleImpliesAttribute() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @return The object regarding RoleImpliesPrivilege where this (the java-object you call objectsOfRoleImpliesPrivilege on) is the subject.
	 */
	public java.util.List<Privilege> objectsOfRoleImpliesPrivilege() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * this is the subject of the relationship.
	 */
	public java.util.List<RoleImpliesPrivilege> whereSubjectOfRoleImpliesPrivilege() throws de.fu.weave.orm.DatabaseException {
	 ...
	 */
	public java.util.List<Person> subjectsOfPersonHasRole() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<PersonHasRole> whereObjectOfPersonHasRole() throws de.fu.weave.orm.DatabaseException {
