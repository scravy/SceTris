...
public class Feature extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		...
		@de.fu.weave.Form.Field("description")
		@de.fu.weave.Form.FormControl(de.fu.weave.Form.Control.TEXTAREA)
		@de.fu.weave.Form.ActiveValidator("description$validator")
		@de.fu.weave.Form.ActiveConverter("description$converter")
	...
	boolean changed_description = false;
	boolean fetched_description = false;
	 ...
	 * @param _description 
	 */
	Feature(RelationManager manager, final boolean full, String _name, String _description) {
		timekey(true);
		if (!full) {
			this.manager = null;
		} else {
	...
	public Feature create() throws de.fu.weave.orm.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"Feature\"" + " (\"name\", \"description\", \"timekey\")"
			+ " VALUES (?, ?, ?) RETURNING id;";
		timekey(true);
		try {
	...
	@de.fu.weave.xml.annotation.XmlAttribute("description")
	@de.fu.weave.orm.annotation.Attribute(name = "description", serial = true, nullable = true)
...
@Override
	...
	/**
	 * Sets the value of <code>description</code>. You may specify null as value.
	 *
	 * If the new value is the same as the old value, this method has no effect, i.e. if you
	 * specify a new value, than {@see isDescriptionChanged()} will return true. If you specify
	 * the same value as the old value isDescriptionChanged() will return the same as it did
	 * before calling <code>setDescription(...)</code>.
	 * 
	 * @since Iteration2
	 */
	public Feature setDescription(String value) {
		
		if (value == null) {
			clearDescription();
			return this;
		}
		if (de.fu.weave.orm.GenericRelationManager.compareValues(_description, value) == 0) return this;
	...
	/**
	 * description may be null, use this function to clear its value.
	 * @since Iteration3
	 */
	public Feature clearDescription() {
		if (_description == null) {
			return this;
		}
		_description = null;
