/* ElementInstanceTakesPlaceInRoom.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"elementInstanceTakesPlaceInRoom\"", requiredSqlCols = {"timeslot"})
...
public class ElementInstanceTakesPlaceInRoom extends de.fu.weave.orm.GenericRelationship {
	...
	ElementInstanceTakesPlaceInRoom(RelationManager manager, java.sql.ResultSet result) throws de.fu.weave.orm.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			this.ref_elementInstance = result.getInt("\"element_instance\"");
			this.ref_room = result.getInt("\"room\"");
	...
	@Override
	public ElementInstanceTakesPlaceInRoom create() throws de.fu.weave.orm.DatabaseException {
	...
	public void pushChanges() throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.weave.orm.OutdatedRecordException("\"scetris\".\"elementInstanceTakesPlaceInRoom\"" + '#' + id());
			}
			_timekey = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.weave.orm.DatabaseException(query, e);
	...
	@de.fu.weave.orm.annotation.Attribute(name = "room", use = "object", ref = Room.class)
	 ...
	 * @since Iteration2
	 */
	public ElementInstanceTakesPlaceInRoom setElementInstance(CourseElementInstance value) {
	 ...
	 * @since Iteration2
	 */
	public ElementInstanceTakesPlaceInRoom setRoom(Room value) {
		if (manager.isNull(value)) {
...
@Override
	 ...
	 * @since Iteration2
	 */
	public ElementInstanceTakesPlaceInRoom setTimeslot(Timeslot value) {
		if (manager.isNull(value)) {
