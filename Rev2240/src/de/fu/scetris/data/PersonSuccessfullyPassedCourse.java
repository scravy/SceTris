/* PersonSuccessfullyPassedCourse.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"personSuccessfullyPassedCourse\"", requiredSqlCols = {})
...
public class PersonSuccessfullyPassedCourse extends de.fu.weave.orm.GenericRelationship {
	...
	PersonSuccessfullyPassedCourse(RelationManager manager, java.sql.ResultSet result) throws de.fu.weave.orm.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			...
			this._grade = result.getString("\"grade\"");
			if (result.wasNull()) {
				this._grade = null;
			}
			this.fetched_grade = true;
			this._notes = result.getString("\"notes\"");
			if (result.wasNull()) {
				this._notes = null;
			}
	...
	@Override
	public PersonSuccessfullyPassedCourse create() throws de.fu.weave.orm.DatabaseException {
	...
	public void pushChanges() throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.weave.orm.OutdatedRecordException("\"scetris\".\"personSuccessfullyPassedCourse\"" + '#' + id());
			}
			_mtime = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.weave.orm.DatabaseException(query, e);
...
@Override
	...
	public PersonSuccessfullyPassedCourse setGrade(String value) {
		...
		if (de.fu.weave.orm.GenericRelationManager.compareValues(_grade, value) == 0) return this;
		changed_grade = true;
		_grade = value;
		return this;
	}
	...
	public PersonSuccessfullyPassedCourse setNotes(String value) {
		...
		if (de.fu.weave.orm.GenericRelationManager.compareValues(_notes, value) == 0) return this;
		changed_notes = true;
		_notes = value;
		return this;
	}
