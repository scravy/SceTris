...
<xsl:template match="/">
	...
	<html id="html">
		<head>
			...
			<link rel="stylesheet" type="text/css" href="{$context-path}/css/fuberlin.css" media="screen"/>
			<link rel="stylesheet" type="text/css" href="{$context-path}/css/az.css" media="screen"/>
			<!-- <link rel="stylesheet" type="text/css" href="{$context-path}/css/az_print.css" media="screen, print"/> -->
...
<div id="az_all">		
	<div id="az_head">
		...
		<p>
			<xsl:choose>
				<xsl:when test="/*/@logged-in = 'yes'">
					<xsl:value-of select="$lang/logged-in-as" />&#160;<strong><xsl:value-of select="concat(/*/*/*/@firstName,' ',/*/*/*/@lastName)"/></strong>&#160;<em>(<xsl:value-of select="/*/*/*/@loginName"/>)</em>&#160;<a href="{$servlet-path}/~logout" class="logout-link">&#x2192; <xsl:value-of select="$lang/do-logout" /></a>
				</xsl:when>
				<xsl:otherwise>
		...
		<ul>
			...
			<li><a href="{$servlet-path}"><xsl:value-of select="$lang/administration" /></a>
				<ul>
					...
					<li><a href="{$servlet-path}/Coursemanagement">Semester &amp; Kurse</a></li>
	...
	<div id="az_site">
		...
		<div id="az_content">
			...
			<div id="az_content_all">
				<div id="az_content_left">
					
					<div id="az_breadcrump">
						<div id="path">
