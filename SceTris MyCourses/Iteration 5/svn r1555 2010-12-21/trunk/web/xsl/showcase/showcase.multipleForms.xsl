...
<xsl:template mode="title" match="vars:meta">
	<xsl:value-of select="$mod-lang/multipleForms/title" />
</xsl:template>

<xsl:template mode="content" match="vars:meta">
	<h1><xsl:value-of select="$mod-lang/multipleForms/heading" /></h1>
	<p>
		<xsl:value-of select="$mod-lang/multipleForms/description" />
	</p>
