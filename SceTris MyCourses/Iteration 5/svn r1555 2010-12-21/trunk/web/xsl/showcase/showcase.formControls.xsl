...
<xsl:template mode="title" match="vars:meta">
	<xsl:value-of select="$mod-lang/formControls/title" />
</xsl:template>

<xsl:template mode="content" match="vars:meta">
	<h1><xsl:value-of select="$mod-lang/formControls/heading" /></h1>
	<p>
		<xsl:value-of select="$mod-lang/formControls/description" />
	</p>
