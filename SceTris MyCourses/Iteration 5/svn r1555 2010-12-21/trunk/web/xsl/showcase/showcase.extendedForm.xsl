...
<xsl:template mode="title" match="vars:meta">
	<xsl:value-of select="$mod-lang/extendedForm/title" />
</xsl:template>

<xsl:template mode="content" match="vars:meta">
	<h1><xsl:value-of select="$mod-lang/extendedForm/heading" /></h1>
	<p>
		<xsl:value-of select="$mod-lang/extendedForm/description" />
	</p>
