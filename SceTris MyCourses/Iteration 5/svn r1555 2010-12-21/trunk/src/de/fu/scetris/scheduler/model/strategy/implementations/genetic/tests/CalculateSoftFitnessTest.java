...
import de.fu.scetris.scheduler.model.strategy.implementations.genetic.CalculateSoftFitnessImpl;
...
public class CalculateSoftFitnessTest {
	...
	public void testCalculateHardFitness() throws DatabaseException {
		...
		double fitness = fitnessCalculation.calculateSoftFitness(schedule,
				configuration);
