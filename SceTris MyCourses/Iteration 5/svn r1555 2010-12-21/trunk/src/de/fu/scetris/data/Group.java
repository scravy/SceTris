 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Entity(name = "Group")
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"Group\"", requiredSqlCols = {"name"})
@de.fu.weave.xml.annotation.XmlElement("Group")
public class Group extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	Group(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	...
	public void create() throws de.fu.bakery.orm.java.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"Group\"" + " (\"name\", \"timekey\")"
			+ " VALUES (?, ?) RETURNING id;";
		timekey(true);
		try {
	...
	public void pushChanges() throws de.fu.bakery.orm.java.DatabaseException {
		...
		String query = "UPDATE " + "\"scetris\".\"Group\"" + " SET \"name\" = ?"
			+ ", \"timekey\" = ? "
	 ...
	 * @since Iteration3
	 */
	public Person subjectOfPersonBelongsToGroup() throws de.fu.bakery.orm.java.DatabaseException {
		java.util.List<Person> coll = subjectsOfPersonBelongsToGroup();
		if (coll.isEmpty()) {
			return null;
		}
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Person> subjectsOfPersonBelongsToGroup() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<PersonBelongsToGroup> whereObjectOfPersonBelongsToGroup() throws de.fu.bakery.orm.java.DatabaseException {
