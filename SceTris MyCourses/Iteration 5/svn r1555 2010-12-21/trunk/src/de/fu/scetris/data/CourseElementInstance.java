/* CourseElementInstance.java / 2010-12-20+01:00
...
public class CourseElementInstance extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		...
		@de.fu.weave.Form.Field("startingTimeslot") @de.fu.weave.Form.Required
		public Timeslot StartingTimeslot;
		
		@de.fu.weave.Form.Field("lecturer") @de.fu.weave.Form.Required
...
@Override
	 ...
	 * @since Iteration2
	 */
	public void setLecturer(Person value) {
		
		if (value == null) {
			clearLecturer();
			return;
		}
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_lecturer, value._id) == 0) return;
