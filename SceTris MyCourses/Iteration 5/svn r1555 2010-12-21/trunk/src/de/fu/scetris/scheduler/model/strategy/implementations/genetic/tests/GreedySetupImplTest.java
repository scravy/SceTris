...
import de.fu.scetris.scheduler.model.strategy.implementations.genetic.GreedySetupImpl;
...
public class GreedySetupImplTest {
	...
	public void testInitialize() throws Exception {
		...
		schedule = new ScheduleImpl(configuration);
		Setup setup = new GreedySetupImpl(new Random(),configuration);
