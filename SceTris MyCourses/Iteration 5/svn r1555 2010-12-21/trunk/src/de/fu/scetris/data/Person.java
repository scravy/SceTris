...
public class Person extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity , de.fu.weave.User {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		...
		@de.fu.weave.Form.Field("ctime") @de.fu.weave.Form.Required
		public java.sql.Timestamp Ctime;
		
		@de.fu.weave.Form.Field("mtime") @de.fu.weave.Form.Required
		@de.fu.weave.Form.FormControl(de.fu.weave.Form.Control.HIDDEN)
		public java.sql.Timestamp Mtime;
		
		@de.fu.weave.Form.Field("createdBy") @de.fu.weave.Form.Required
		public Person CreatedBy;
		
		@de.fu.weave.Form.Field("modifiedBy") @de.fu.weave.Form.Required
		public Person ModifiedBy;
		
		@de.fu.weave.Form.Field("firstName") @de.fu.weave.Form.Required
		public String FirstName;
		
		@de.fu.weave.Form.Field("additionalNames") @de.fu.weave.Form.Required
		public String AdditionalNames;
		
		@de.fu.weave.Form.Field("lastName") @de.fu.weave.Form.Required
		public String LastName;
		
		@de.fu.weave.Form.Field("emailAddress") @de.fu.weave.Form.Required
		...
		@de.fu.weave.Form.Field("deleted") @de.fu.weave.Form.Required
		public java.sql.Timestamp Deleted;
		
		@de.fu.weave.Form.Field("deletedBy") @de.fu.weave.Form.Required
		public Person DeletedBy;
		
		@de.fu.weave.Form.Field("workingHours") @de.fu.weave.Form.Required
		public Integer WorkingHours;
		
		@de.fu.weave.Form.Field("studentId") @de.fu.weave.Form.Required
		public String StudentId;
		
		@de.fu.weave.Form.Field("staffId") @de.fu.weave.Form.Required
