/* RelationManager.java / 2010-12-20+01:00
...
public class RelationManager extends de.fu.bakery.orm.java.GenericRelationManager {
	 ...
	 * @since Iteration2
	 */
	public CourseElementInstance fullyCreateCourseElementInstance(CourseInstance _courseInstance, CourseElement _courseElement, Timeslot _startingTimeslot, Person _lecturer, int _duration, boolean _schedulableLesson) throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration2
	 */
	public CourseElementInstance fullyNewCourseElementInstance(CourseInstance _courseInstance, CourseElement _courseElement, Timeslot _startingTimeslot, Person _lecturer, int _duration, boolean _schedulableLesson) throws de.fu.bakery.orm.java.DatabaseException {
	...
	public boolean install() throws de.fu.bakery.orm.java.DatabaseException {
		try {
			...
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822277_name ON \"scetris\".\"Feature\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822391_name ON \"scetris\".\"Group\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822918_email_address ON \"scetris\".\"Person\" (\"email_address\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822925_login_name ON \"scetris\".\"Person\" (\"login_name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822932_student_id ON \"scetris\".\"Person\" (\"student_id\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822940_staff_id ON \"scetris\".\"Person\" (\"staff_id\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823054_name ON \"scetris\".\"Privilege\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823544_element_instance ON \"scetris\".\"ProposedScheduling\" (\"element_instance\", \"timeslot\", \"room\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823667_name ON \"scetris\".\"Role\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823830_name ON \"scetris\".\"Room\" (\"name\", \"building\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35824088_name ON \"scetris\".\"Year\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35824797_room ON \"scetris\".\"elementInstanceTakesPlaceInRoom\" (\"room\", \"timeslot\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35826417_user ON \"scetris\".\"personTakesPartInElementInstance\" (\"user\", \"timeslot\"); ");
