...
public abstract class FriggModule<R extends RelationManager> implements Module<R> {
	...
	public static abstract class AbstractForm implements Form {
		...
		private final TreeMap<String,Exception> $_messages = new TreeMap<String,Exception>();

		@Override
		public void addMessage(final String $field, final Exception $exc) {
			$_messages.put($field, $exc);
		}
