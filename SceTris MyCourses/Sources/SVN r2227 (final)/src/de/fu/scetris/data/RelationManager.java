/* RelationManager.java / 2011-03-03+01:00
...
public class RelationManager extends de.fu.weave.orm.GenericRelationManager
	implements java.lang.Cloneable, RelationManagerInterface {
	...
	public CourseHasCourseAttribute fullyNewCourseHasCourseAttribute(Course subject, CourseAttribute object, java.sql.Timestamp _time, String _value) {
		return new CourseHasCourseAttribute(this, true, subject, object, _time, _value);
	}
	...
	public CourseHasCourseAttribute fullyCreateCourseHasCourseAttribute(Course subject, CourseAttribute object, java.sql.Timestamp _time, String _value) throws de.fu.weave.orm.DatabaseException {
		CourseHasCourseAttribute obj = fullyNewCourseHasCourseAttribute(subject, object, _time, _value);
		obj.create();
		return obj;
	}
	...
	public CourseHasCourseAttribute newCourseHasCourseAttribute(Course subject, CourseAttribute object, String _value) {
		return new CourseHasCourseAttribute(this, subject, object, _value);
	}
	...
	public CourseHasCourseAttribute createCourseHasCourseAttribute(Course subject, CourseAttribute object, String _value) throws de.fu.weave.orm.DatabaseException {
		CourseHasCourseAttribute obj = newCourseHasCourseAttribute(subject, object, _value);
		obj.create();
		return obj;
	}
	...
	public PersonHasAttribute fullyNewPersonHasAttribute(Person subject, Attribute object, java.sql.Timestamp _time, String _value) {
		return new PersonHasAttribute(this, true, subject, object, _time, _value);
	}
	...
	public PersonHasAttribute fullyCreatePersonHasAttribute(Person subject, Attribute object, java.sql.Timestamp _time, String _value) throws de.fu.weave.orm.DatabaseException {
		PersonHasAttribute obj = fullyNewPersonHasAttribute(subject, object, _time, _value);
		obj.create();
		return obj;
	}
	...
	public PersonHasAttribute newPersonHasAttribute(Person subject, Attribute object, String _value) {
		return new PersonHasAttribute(this, subject, object, _value);
	}
	...
	public PersonHasAttribute createPersonHasAttribute(Person subject, Attribute object, String _value) throws de.fu.weave.orm.DatabaseException {
		PersonHasAttribute obj = newPersonHasAttribute(subject, object, _value);
		obj.create();
		return obj;
	}
	...
	public Course fullyCreateCourse(String _name, Department _department) throws de.fu.weave.orm.DatabaseException {
		Course entity = fullyNewCourse(_name, _department);
		entity.create();
		return entity;
	}
	...
	public Course fullyNewCourse(String _name, Department _department) throws de.fu.weave.orm.DatabaseException {
		Course entity = new Course(this, true, _name, _department);
		return entity;
	}
	...
	public Feature fullyCreateFeature(String _name, String _description) throws de.fu.weave.orm.DatabaseException {
		Feature entity = fullyNewFeature(_name, _description);
		entity.create();
		return entity;
	}
	...
	public Feature fullyNewFeature(String _name, String _description) throws de.fu.weave.orm.DatabaseException {
		Feature entity = new Feature(this, true, _name, _description);
		return entity;
	}
	...
	public Person fullyCreatePerson(java.sql.Timestamp _ctime, Person _createdBy, Person _modifiedBy, String _firstName, String _additionalNames, String _lastName, String _emailAddress, String _loginName, String _loginPassword, Department _homeDepartment, Year _currentYear, java.sql.Timestamp _lastLogin, int _loginCount, boolean _isSuperuser, java.sql.Timestamp _deleted, Person _deletedBy, boolean _isStudent, boolean _isLecturer) throws de.fu.weave.orm.DatabaseException {
		Person entity = fullyNewPerson(_ctime, _createdBy, _modifiedBy, _firstName, _additionalNames, _lastName, _emailAddress, _loginName, _loginPassword, _homeDepartment, _currentYear, _lastLogin, _loginCount, _isSuperuser, _deleted, _deletedBy, _isStudent, _isLecturer);
		entity.create();
		return entity;
	}
	...
	public Person fullyNewPerson(java.sql.Timestamp _ctime, Person _createdBy, Person _modifiedBy, String _firstName, String _additionalNames, String _lastName, String _emailAddress, String _loginName, String _loginPassword, Department _homeDepartment, Year _currentYear, java.sql.Timestamp _lastLogin, int _loginCount, boolean _isSuperuser, java.sql.Timestamp _deleted, Person _deletedBy, boolean _isStudent, boolean _isLecturer) throws de.fu.weave.orm.DatabaseException {
		Person entity = new Person(this, true, _ctime, _createdBy, _modifiedBy, _firstName, _additionalNames, _lastName, _emailAddress, _loginName, _loginPassword, _homeDepartment, _currentYear, _lastLogin, _loginCount, _isSuperuser, _deleted, _deletedBy, _isStudent, _isLecturer);
		return entity;
	}
	...
	public boolean install() throws de.fu.weave.orm.DatabaseException {
		try {
			...
			stmt.executeUpdate("CREATE TABLE \"scetris\".\"Course\" ( 	\"id\" SERIAL NOT NULL, 	\"name\" VARCHAR NOT NULL, 	\"timekey\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	\"department\" INTEGER, 	PRIMARY KEY (\"id\") );");
			...
			stmt.executeUpdate("CREATE TABLE \"scetris\".\"Feature\" ( 	\"id\" SERIAL NOT NULL, 	\"name\" VARCHAR NOT NULL, 	\"timekey\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	\"description\" TEXT, 	PRIMARY KEY (\"id\") );");
			stmt.executeUpdate("CREATE TABLE \"scetris\".\"Person\" ( 	\"id\" SERIAL NOT NULL, 	\"ctime\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	\"mtime\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	\"created_by\" INTEGER, 	\"modified_by\" INTEGER, 	\"first_name\" VARCHAR NOT NULL, 	\"additional_names\" VARCHAR, 	\"last_name\" VARCHAR NOT NULL, 	\"email_address\" VARCHAR, 	\"login_name\" VARCHAR NOT NULL, 	\"login_password\" VARCHAR (32) NOT NULL, 	\"home_department\" INTEGER, 	\"current_year\" INTEGER, 	\"last_login\" TIMESTAMP (3), 	\"login_count\" INTEGER NOT NULL DEFAULT 0, 	\"is_superuser\" BOOLEAN NOT NULL DEFAULT false, 	\"deleted\" TIMESTAMP (3), 	\"deleted_by\" INTEGER, 	\"is_student\" BOOLEAN NOT NULL DEFAULT false, 	\"is_lecturer\" BOOLEAN NOT NULL DEFAULT false, 	PRIMARY KEY (\"id\") );");
			...
			stmt.executeUpdate("CREATE TABLE \"scetris\".\"courseHasCourseAttribute\" ( 	\"course\" INTEGER NOT NULL, 	\"attribute\" INTEGER NOT NULL, 	\"time\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	\"value\" VARCHAR NOT NULL, 	\"timekey\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	PRIMARY KEY (\"course\", \"attribute\", \"time\") );");
			...
			stmt.executeUpdate("CREATE TABLE \"scetris\".\"elementInstancePrefersTimeslot\" ( 	\"element_instance\" INTEGER NOT NULL, 	\"timeslot\" INTEGER NOT NULL, 	\"priority\" INTEGER NOT NULL, 	\"timekey\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	PRIMARY KEY (\"element_instance\", \"timeslot\") );");
			...
			stmt.executeUpdate("CREATE TABLE \"scetris\".\"personHasAttribute\" ( 	\"user\" INTEGER NOT NULL, 	\"attribute\" INTEGER NOT NULL, 	\"time\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	\"value\" VARCHAR NOT NULL, 	\"timekey\" TIMESTAMP (3) NOT NULL DEFAULT CURRENT_TIMESTAMP, 	PRIMARY KEY (\"user\", \"attribute\", \"time\") );");
			...
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35820949_name ON \"scetris\".\"Course\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35821138_name ON \"scetris\".\"CourseAttribute\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35821733_name ON \"scetris\".\"CourseElementType\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822047_name ON \"scetris\".\"Day\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822189_name ON \"scetris\".\"Department\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822318_name ON \"scetris\".\"Feature\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822931_email_address ON \"scetris\".\"Person\" (\"email_address\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822938_login_name ON \"scetris\".\"Person\" (\"login_name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823052_name ON \"scetris\".\"Privilege\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823542_element_instance ON \"scetris\".\"ProposedScheduling\" (\"element_instance\", \"timeslot\", \"room\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823665_name ON \"scetris\".\"Role\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823828_name ON \"scetris\".\"Room\" (\"name\", \"building\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823840_number ON \"scetris\".\"Room\" (\"number\", \"building\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35824098_name ON \"scetris\".\"Year\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35826040_user ON \"scetris\".\"personTakesPartInElementInstance\" (\"user\", \"timeslot\"); ");
			...
			stmt.executeUpdate("ALTER TABLE \"scetris\".\"Course\" ADD FOREIGN KEY (\"department\") REFERENCES \"scetris\".\"Department\" ON DELETE CASCADE;");
			...
			stmt.executeUpdate("ALTER TABLE \"scetris\".\"Person\" ADD FOREIGN KEY (\"home_department\") REFERENCES \"scetris\".\"Department\" ON DELETE CASCADE;");
			stmt.executeUpdate("ALTER TABLE \"scetris\".\"Person\" ADD FOREIGN KEY (\"current_year\") REFERENCES \"scetris\".\"Year\" ON DELETE CASCADE;");
			...
			stmt.executeUpdate("ALTER TABLE \"scetris\".\"elementInstancePrefersTimeslot\" ADD FOREIGN KEY (\"element_instance\") REFERENCES \"scetris\".\"CourseElementInstance\" ON DELETE CASCADE;");
