/* PersonGivesCourse.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"personGivesCourse\"", requiredSqlCols = {"priority"})
...
public class PersonGivesCourse extends de.fu.weave.orm.GenericRelationship {
	...
	PersonGivesCourse(RelationManager manager, java.sql.ResultSet result) throws de.fu.weave.orm.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			this.ref_person = result.getInt("\"person\"");
	...
	@Override
	public PersonGivesCourse create() throws de.fu.weave.orm.DatabaseException {
	...
	public void pushChanges() throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.weave.orm.OutdatedRecordException("\"scetris\".\"personGivesCourse\"" + '#' + id());
			}
			_timekey = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.weave.orm.DatabaseException(query, e);
	...
	@de.fu.weave.orm.annotation.Attribute(name = "person", use = "subject", ref = Person.class)
	 ...
	 * @since Iteration2
	 */
	public PersonGivesCourse setPerson(Person value) {
		if (manager.isNull(value)) {
			throw new java.lang.IllegalArgumentException("person is not nullable, null given");
		}
		
		if (de.fu.weave.orm.GenericRelationManager.compareValues(ref_person, value._id) == 0) return this;
		changed_person = true;
	 ...
	 * @since Iteration2
	 */
	public PersonGivesCourse setCourse(Course value) {
		if (manager.isNull(value)) {
...
@Override
	 ...
	 * @since Iteration2
	 */
	public PersonGivesCourse setPriority(int value) {
		if (manager.isNull(value)) {
