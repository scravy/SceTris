...
public aspect InstallPrivileges {
	...
	public synchronized boolean RelationManager.installPrivileges(org.w3c.dom.Document $privileges) throws DatabaseException {
    	String[][] $roles = {
                {"User management (create)", "admin.createUser", "admin.createRole", "admin.createPrivilege"},
                {"Course management (create)", "admin.createCourse", "admin.createCourseElement", "admin.createCourseElementInstance", "admin.createCourseInstance", "admin.createProgram", "admin.createAcademicTerm", "admin.createYear"},
