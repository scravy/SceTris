...
public class RoomComparator implements Comparator<Room> {
	...
	public RoomComparator(Random random, Collection<Room> roomList,
	...
	public int compare(Room room1, Room room2) {
		...
		Integer numberOfFeatureRoom1 = roomToFeaturesQuantity.get(room1).size();
		Integer numberOfFeatureRoom2 = roomToFeaturesQuantity.get(room2).size();

		if (numberOfFeatureRoom1 != numberOfFeatureRoom2) {
			return numberOfFeatureRoom1.compareTo(numberOfFeatureRoom2);
		}
