...
public class Configuration {
	...
	public Map<CourseElementInstance, Year> courseToRecommendedYear;
	...
	public Configuration(final List<Room> roomList,
			...
			final List<CourseRecommendedForYear> courseRecommendedForYearList)
			throws DatabaseException {
		...
		courseToRecommendedYear = new TreeMap<CourseElementInstance, Year>();
		for (CourseRecommendedForYear courseRecommendedForYear : courseRecommendedForYearList) {
			for (CourseElementInstance courseElementInstance : courseList) {
				if (courseElementInstance.getCourseElement().getPartOf()
						.equals(courseRecommendedForYear.getCourse())) {
					courseToRecommendedYear.put(courseElementInstance,
							courseRecommendedForYear.getYear());
				}
			}
		}
	}
