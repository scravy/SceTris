/* PersonEnrolledInCourseInstance.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"personEnrolledInCourseInstance\"", requiredSqlCols = {})
...
public class PersonEnrolledInCourseInstance extends de.fu.weave.orm.GenericRelationship {
	...
	PersonEnrolledInCourseInstance(RelationManager manager, java.sql.ResultSet result) throws de.fu.weave.orm.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			this.ref_user = result.getInt("\"user\"");
			this.ref_courseInstance = result.getInt("\"course_instance\"");
	...
	@Override
	public PersonEnrolledInCourseInstance create() throws de.fu.weave.orm.DatabaseException {
	...
	public void pushChanges() throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.weave.orm.OutdatedRecordException("\"scetris\".\"personEnrolledInCourseInstance\"" + '#' + id());
			}
			_mtime = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.weave.orm.DatabaseException(query, e);
	 ...
	 * @since Iteration2
	 */
	public PersonEnrolledInCourseInstance setUser(Person value) {
	 ...
	 * @since Iteration2
	 */
	public PersonEnrolledInCourseInstance setCourseInstance(CourseInstance value) {
		if (manager.isNull(value)) {
	 ...
	 * @since Iteration2
	 */
	public PersonEnrolledInCourseInstance setCtime(java.sql.Timestamp value) {
		if (manager.isNull(value)) {
...
@Override
	 ...
	 * @since Iteration2
	 */
	public PersonEnrolledInCourseInstance setCreatedBy(Person value) {
	 ...
	 * @since Iteration3
	 */
	public PersonEnrolledInCourseInstance clearCreatedBy() {
	 ...
	 * @since Iteration2
	 */
	public PersonEnrolledInCourseInstance setModifiedBy(Person value) {
	 ...
	 * @since Iteration3
	 */
	public PersonEnrolledInCourseInstance clearModifiedBy() {
