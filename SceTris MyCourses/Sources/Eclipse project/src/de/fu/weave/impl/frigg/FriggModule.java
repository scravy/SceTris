 ...
 * <p>
 * A module is dynamically loaded at startup of a {@link Weavlet}. The modules to be loaded are
...
public abstract class FriggModule<R extends RelationManager> implements Module<R> {
	 ...
	 */
	protected final Weavlet<R> parent;
	 ...
	 * @param parent
	 */
	public FriggModule(final Weavlet<R> parent) {
		super();
		this.parent = parent;
	...
	@Override
	public final Weavlet<R> getParent() {
		return parent;
	}
