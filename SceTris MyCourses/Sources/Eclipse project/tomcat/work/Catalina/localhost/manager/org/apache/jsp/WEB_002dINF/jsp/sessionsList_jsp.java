...
public final class sessionsList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String path = (String) request.getAttribute("path");
   ...
   Collection activeSessions = (Collection) request.getAttribute("activeSessions");
      ...
      out.write("\t<meta name=\"copyright\" content=\"copyright 2005-2010 the Apache Software Foundation\"/>\n");
      ...
      out.print( (String) request.getAttribute("sort") );
      out.write("\"/>\n");
      out.write("\t\t");
 ...
 Iterator iter = activeSessions.iterator();
   while (iter.hasNext()) {
      ...
      out.print( JspHelper.escapeXml(currentSessionId) );
      out.write("</a>\n");
      out.write("\t\t\t\t\t</td>\n");
      ...
      out.write("</form>\n");
      out.write("\n");
      out.write("<p style=\"text-align: center;\"><button type=\"button\" onclick=\"window.close()\">Close window</button></p>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("</body>\n");
