...
<xsl:template mode="content" match="vars:meta">
	...
	<xsl:for-each select="vars:proposals/item:proposals">
		...
		<tr>
			<td>
				<xsl:value-of select="vars:timeslot/item:timeslot/vars:day/item:day/@name"/>,
				<xsl:value-of select="vars:timeslot/item:timeslot/@startingTime"/>				
			</td>
			<td><a href="{$servlet-path}/admin/showRoom/{vars:room/item:room/@id}">
				<xsl:value-of select="vars:room/item:room/vars:building/item:building/@name"/>,
				<xsl:value-of select="vars:room/item:room/@name"/>
				</a>
			</td>
			<td><xsl:value-of select="vars:elementInstance/item:elementInstance/vars:courseElement/item:courseElement/vars:type/item:type/@name"/></td>
			<td><xsl:value-of select="vars:elementInstance/item:elementInstance/@duration"/></td>
			<td>
