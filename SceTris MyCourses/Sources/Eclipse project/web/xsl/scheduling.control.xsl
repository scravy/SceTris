...
<xsl:transform version="1.0"
	...
	<!-- andre: i broke sth. here, need old imports, i'm sorry :(, look at revision 1715 for working imports -->
		...
		<form method="post">
			...
			<xsl:choose>
				...
				<xsl:when test="//vars:status='ready'">
					...
					<input type="submit" value="resume" name="command" />
					<input disabled="disabled" type="submit" value="stop" name="command" />
					<input type="submit" value="publish" name="command" />
				</xsl:when>

				<xsl:when test="//vars:status='stopping'">
					<input disabled="disabled" type="submit" value="start" name="command" />
					<input disabled="disabled" type="submit" value="resume" name="command" />
					<input disabled="disabled" type="submit" value="stop" name="command" />
					<input disabled="disabled" type="submit" value="publish" name="command" />
				</xsl:when>
