...
public class Room extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	@Override
	public Room create() throws de.fu.bakery.orm.java.DatabaseException {
...
@Override
	...
	public Room setNumber(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_number, value) == 0) return this;
		changed_number = true;
		_number = value;
		return this;
	}
	...
	public Room setBuilding(Building value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_building, value._id) == 0) return this;
