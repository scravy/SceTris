/* RoomPrefersTimeslot.java / 2011-01-15+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Relationship(name = "roomPrefersTimeslot", subject = Room.class, object = Timeslot.class)
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"roomPrefersTimeslot\"", requiredSqlCols = {"priority"})
@de.fu.weave.xml.annotation.XmlElement("roomPrefersTimeslot")
public class RoomPrefersTimeslot extends de.fu.bakery.orm.java.GenericRelationship {
	...
	RoomPrefersTimeslot(RelationManager manager, Room subject, Timeslot object, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	...
	RoomPrefersTimeslot(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			ref_room = result.getInt("room");
	...
	@Override
	public RoomPrefersTimeslot create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	public void pushChanges() throws de.fu.bakery.orm.java.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.bakery.orm.java.OutdatedRecordException("\"scetris\".\"roomPrefersTimeslot\"" + '#' + id());
			}
			_timekey = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.bakery.orm.java.DatabaseException(query, e);
