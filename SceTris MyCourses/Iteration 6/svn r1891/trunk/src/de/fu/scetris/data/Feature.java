 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Entity(name = "Feature")
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"Feature\"", requiredSqlCols = {"name"})
@de.fu.weave.xml.annotation.XmlElement("Feature")
public class Feature extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	Feature(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 */
	@Override
	public Feature create() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public CourseElementInstance subjectOfElementInstanceRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<CourseElementInstance> subjectsOfElementInstanceRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementInstanceRequiresFeature> whereObjectOfElementInstanceRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public CourseElement subjectOfElementRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<CourseElement> subjectsOfElementRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementRequiresFeature> whereObjectOfElementRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public Room subjectOfRoomProvidesFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Room> subjectsOfRoomProvidesFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<RoomProvidesFeature> whereObjectOfRoomProvidesFeature() throws de.fu.bakery.orm.java.DatabaseException {
