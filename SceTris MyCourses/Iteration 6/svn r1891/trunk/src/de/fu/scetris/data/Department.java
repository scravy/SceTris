/* Department.java / 2011-01-15+01:00
...
public class Department extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	@Override
	public Department create() throws de.fu.bakery.orm.java.DatabaseException {
...
@Override
	...
	public Department setSuperordinateDepartment(Department value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_superordinateDepartment, value._id) == 0) return this;
