/* ElementRequiresFeature.java / 2011-01-15+01:00
...
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"elementRequiresFeature\"", requiredSqlCols = {"quantity_min", "quantity_better"})
...
public class ElementRequiresFeature extends de.fu.bakery.orm.java.GenericRelationship {
	...
	@Override
	public ElementRequiresFeature create() throws de.fu.bakery.orm.java.DatabaseException {
