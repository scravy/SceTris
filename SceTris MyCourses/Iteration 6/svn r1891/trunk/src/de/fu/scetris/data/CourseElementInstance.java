/* CourseElementInstance.java / 2011-01-15+01:00
...
public class CourseElementInstance extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	@Override
	public CourseElementInstance create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "lecturer", serial = true, nullable = true, ref = Person.class)
	public Person getLecturer() throws de.fu.bakery.orm.java.DatabaseException {
		if (ref_lecturer == null) {
			return null;
		}
		if (!fetched_lecturer) {
...
@Override
	...
	public CourseElementInstance setCourseInstance(CourseInstance value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_courseInstance, value._id) == 0) return this;
	...
	public CourseElementInstance setCourseElement(CourseElement value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_courseElement, value._id) == 0) return this;
	...
	public CourseElementInstance setStartingTimeslot(Timeslot value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_startingTimeslot, value._id) == 0) return this;
	...
	public CourseElementInstance setLecturer(Person value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_lecturer, value._id) == 0) return this;
	...
	public CourseElementInstance setSchedulableLesson(boolean value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_schedulableLesson, value) == 0) return this;
