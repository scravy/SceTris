...
public interface AbstractFactory {
	...
	public HardFitnessCalculation createCalculateHardFitness(Configuration config);

	public SoftFitnessCalculation createCalculateSoftFitness(Configuration config);
