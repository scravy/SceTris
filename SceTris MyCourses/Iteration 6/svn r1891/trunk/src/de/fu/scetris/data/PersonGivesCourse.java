/* PersonGivesCourse.java / 2011-01-15+01:00
...
public class PersonGivesCourse extends de.fu.bakery.orm.java.GenericRelationship {
	...
	@Override
	public PersonGivesCourse create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	public PersonGivesCourse setPerson(Person value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_person, value._id) == 0) return this;
		changed_person = true;
