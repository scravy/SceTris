...
public class Program extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	@Override
	public Program create() throws de.fu.bakery.orm.java.DatabaseException {
...
@Override
	...
	public Program setAcademicTerm(AcademicTerm value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_academicTerm, value._id) == 0) return this;
	...
	public Program setFreezed(boolean value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_freezed, value) == 0) return this;
	...
	public Program setPublished(boolean value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_published, value) == 0) return this;
	...
	public Program setProgramManager(Person value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_programManager, value._id) == 0) return this;
