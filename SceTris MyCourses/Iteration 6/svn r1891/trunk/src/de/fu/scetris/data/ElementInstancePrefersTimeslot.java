/* ElementInstancePrefersTimeslot.java / 2011-01-15+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Relationship(name = "elementInstancePrefersTimeslot", subject = CourseElementInstance.class, object = Timeslot.class)
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"elementInstancePrefersTimeslot\"", requiredSqlCols = {"priority"})
@de.fu.weave.xml.annotation.XmlElement("elementInstancePrefersTimeslot")
public class ElementInstancePrefersTimeslot extends de.fu.bakery.orm.java.GenericRelationship {
	...
	ElementInstancePrefersTimeslot(RelationManager manager, CourseElementInstance subject, Timeslot object, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	...
	ElementInstancePrefersTimeslot(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			ref_room = result.getInt("room");
	...
	@Override
	public ElementInstancePrefersTimeslot create() throws de.fu.bakery.orm.java.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"elementInstancePrefersTimeslot\"" + " (\"room\", \"timeslot\","
			+ "\"priority\", \"timekey\")"
			+ " VALUES (?, ?, ?, ?);";
		try {
	...
	public void pushChanges() throws de.fu.bakery.orm.java.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.bakery.orm.java.OutdatedRecordException("\"scetris\".\"elementInstancePrefersTimeslot\"" + '#' + id());
			}
			_timekey = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.bakery.orm.java.DatabaseException(query, e);
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "room", use = "subject", ref = CourseElementInstance.class)
	public CourseElementInstance getRoom() throws de.fu.bakery.orm.java.DatabaseException {
		if (!fetched_room) {
	 ...
	 * @since Iteration2
	 */
	public ElementInstancePrefersTimeslot setRoom(CourseElementInstance value) {
		if (manager.isNull(value)) {
			throw new java.lang.IllegalArgumentException("room is not nullable, null given");
		}
		
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_room, value._id) == 0) return this;
		changed_room = true;
		ref_room = value._id;
		fetched_room = true;
		_room = value;
	...
	public ElementInstancePrefersTimeslot setTimeslot(Timeslot value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_timeslot, value._id) == 0) return this;
	...
	public ElementInstancePrefersTimeslot setPriority(int value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_priority, value) == 0) return this;
