/* RoomProvidesFeature.java / 2011-01-15+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Relationship(name = "roomProvidesFeature", subject = Room.class, object = Feature.class)
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"roomProvidesFeature\"", requiredSqlCols = {"quantity"})
@de.fu.weave.xml.annotation.XmlElement("roomProvidesFeature")
public class RoomProvidesFeature extends de.fu.bakery.orm.java.GenericRelationship {
	...
	RoomProvidesFeature(RelationManager manager, Room subject, Feature object, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	...
	RoomProvidesFeature(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			ref_room = result.getInt("room");
	...
	@Override
	public Room subject() throws de.fu.bakery.orm.java.DatabaseException {
		if (subject == null) {
	...
	@Override
	public RoomProvidesFeature create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	public void pushChanges() throws de.fu.bakery.orm.java.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.bakery.orm.java.OutdatedRecordException("\"scetris\".\"roomProvidesFeature\"" + '#' + id());
			}
			_timekey = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.bakery.orm.java.DatabaseException(query, e);
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "room", use = "subject", ref = Room.class)
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "quantity", serial = true)
	...
	public RoomProvidesFeature setFeature(Feature value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_feature, value._id) == 0) return this;
...
@Override
	...
	public RoomProvidesFeature setQuantity(int value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_quantity, value) == 0) return this;
