/* AcademicTerm.java / 2011-01-15+01:00
...
public class AcademicTerm extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	@Override
	public AcademicTerm create() throws de.fu.bakery.orm.java.DatabaseException {
...
@Override
	...
	public AcademicTerm setStartLessons(java.sql.Date value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_startLessons, value) == 0) return this;
	...
	public AcademicTerm setEndLessons(java.sql.Date value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_endLessons, value) == 0) return this;
