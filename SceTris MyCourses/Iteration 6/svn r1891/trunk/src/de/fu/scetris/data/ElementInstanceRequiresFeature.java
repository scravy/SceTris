/* ElementInstanceRequiresFeature.java / 2011-01-15+01:00
...
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"elementInstanceRequiresFeature\"", requiredSqlCols = {"quantity_min", "quantity_better"})
...
public class ElementInstanceRequiresFeature extends de.fu.bakery.orm.java.GenericRelationship {
	...
	@Override
	public ElementInstanceRequiresFeature create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "quantity_min", serial = true)
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "quantity_better", serial = true)
	...
	public ElementInstanceRequiresFeature setElementInstance(CourseElementInstance value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_elementInstance, value._id) == 0) return this;
...
@Override
	...
	public ElementInstanceRequiresFeature setQuantityMin(int value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_quantityMin, value) == 0) return this;
	...
	public ElementInstanceRequiresFeature setQuantityBetter(int value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_quantityBetter, value) == 0) return this;
