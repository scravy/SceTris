 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Entity(name = "Day")
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"Day\"", requiredSqlCols = {"name"})
@de.fu.weave.xml.annotation.XmlElement("Day")
public class Day extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		public static final long serialVersionUID = 2595395L;
		...
		public Form setValues(Day $object) {
	 ...
	 */
	Day(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 */
	@Override
	public Day create() throws de.fu.bakery.orm.java.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"Day\"" + " (\"name\", \"timekey\")"
			+ " VALUES (?, ?) RETURNING id;";
		timekey(true);
		try {
	...
	public void pushChanges() throws de.fu.bakery.orm.java.DatabaseException {
		...
		String query = "UPDATE " + "\"scetris\".\"Day\"" + " SET \"name\" = ?"
			+ ", \"timekey\" = ? "
	 ...
	 * @since Iteration2
	 */
	public Day setName(String value) {
