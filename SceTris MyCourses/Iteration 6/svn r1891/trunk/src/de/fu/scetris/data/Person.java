...
public class Person extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity , de.fu.weave.User {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		...
		@de.fu.weave.Form.Field("workingHours")
		@de.fu.weave.Form.ActiveValidator("workingHours$validator")
		@de.fu.weave.Form.ActiveConverter("workingHours$converter")
		...
		public Form setValues(Person $object) {
			...
			workingHours = $object.getWorkingHours();
	 ...
	 */
	@Override
	public Person create() throws de.fu.bakery.orm.java.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"Person\"" + " (\"ctime\", \"created_by\", \"modified_by\", \"first_name\", \"additional_names\", \"last_name\", \"email_address\", \"login_name\", \"login_password\", \"is_superuser\", \"deleted\", \"deleted_by\", \"working_hours\", \"is_student\", \"is_lecturer\", \"mtime\")"
			+ " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id;";
		timekey(true);
		try {
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "deleted", serial = true, nullable = true, hidden = true)
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "deleted_by", serial = true, nullable = true, hidden = true, ref = Person.class)
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "is_student", serial = true)
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "is_lecturer", serial = true)
...
@Override
	...
	public Person setFirstName(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_firstName, value) == 0) return this;
	...
	public Person setAdditionalNames(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_additionalNames, value) == 0) return this;
	...
	public Person setLastName(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_lastName, value) == 0) return this;
	...
	public Person setEmailAddress(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_emailAddress, value) == 0) return this;
	...
	public Person setLoginName(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_loginName, value) == 0) return this;
	...
	public Person setLoginPassword(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_loginPassword, value) == 0) return this;
	...
	public Person setIsSuperuser(boolean value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_isSuperuser, value) == 0) return this;
	...
	public Person setDeleted(java.sql.Timestamp value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_deleted, value) == 0) return this;
	...
	public Person setDeletedBy(Person value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_deletedBy, value._id) == 0) return this;
	 ...
	 * @since Iteration2
	 */
	public Person setWorkingHours(Integer value) {
		
		if (value == null) {
			clearWorkingHours();
			return this;
		}
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_workingHours, value) == 0) return this;
	 ...
	 * @since Iteration3
	 */
	public Person clearWorkingHours() {
		if (_workingHours == null) {
			return this;
		}
		_workingHours = null;
	...
	public Person setIsStudent(boolean value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_isStudent, value) == 0) return this;
	...
	public Person setIsLecturer(boolean value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_isLecturer, value) == 0) return this;
