/* CourseInstance.java / 2011-01-15+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Entity(name = "CourseInstance")
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"CourseInstance\"", requiredSqlCols = {"program", "instance_of", "start", "end", "main_lecturer"})
@de.fu.weave.xml.annotation.XmlElement("CourseInstance")
public class CourseInstance extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	CourseInstance(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 */
	@Override
	public CourseInstance create() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public Person subjectOfPersonEnrolledInCourseInstance() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Person> subjectsOfPersonEnrolledInCourseInstance() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<PersonEnrolledInCourseInstance> whereObjectOfPersonEnrolledInCourseInstance() throws de.fu.bakery.orm.java.DatabaseException {
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "program", serial = true, ref = Program.class)
	public Program getProgram() throws de.fu.bakery.orm.java.DatabaseException {
		if (!fetched_program) {
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "instance_of", serial = true, ref = Course.class)
	public Course getInstanceOf() throws de.fu.bakery.orm.java.DatabaseException {
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "main_lecturer", serial = true, ref = Person.class)
	public Person getMainLecturer() throws de.fu.bakery.orm.java.DatabaseException {
...
@Override
	...
	public CourseInstance setProgram(Program value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_program, value._id) == 0) return this;
	...
	public CourseInstance setInstanceOf(Course value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_instanceOf, value._id) == 0) return this;
	...
	public CourseInstance setStart(java.sql.Date value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_start, value) == 0) return this;
		changed_start = true;
		_start = value;
		return this;
	}
	...
	public CourseInstance setEnd(java.sql.Date value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_end, value) == 0) return this;
		changed_end = true;
		_end = value;
		return this;
	}
	...
	public CourseInstance setMainLecturer(Person value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_mainLecturer, value._id) == 0) return this;
