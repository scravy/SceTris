/* Privilege.java / 2011-01-15+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Entity(name = "Privilege")
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"Privilege\"", requiredSqlCols = {"name"})
@de.fu.weave.xml.annotation.XmlElement("Privilege")
public class Privilege extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	 ...
	 */
	Privilege(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 */
	@Override
	public Privilege create() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public Person subjectOfPersonHasPrivilege() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Person> subjectsOfPersonHasPrivilege() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<PersonHasPrivilege> whereObjectOfPersonHasPrivilege() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public Role subjectOfRoleImpliesPrivilege() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Role> subjectsOfRoleImpliesPrivilege() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<RoleImpliesPrivilege> whereObjectOfRoleImpliesPrivilege() throws de.fu.bakery.orm.java.DatabaseException {
