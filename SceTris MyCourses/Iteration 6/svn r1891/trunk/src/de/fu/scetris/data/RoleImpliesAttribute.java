/* RoleImpliesAttribute.java / 2011-01-15+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Relationship(name = "roleImpliesAttribute", subject = Role.class, object = Attribute.class)
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"roleImpliesAttribute\"", requiredSqlCols = {})
@de.fu.weave.xml.annotation.XmlElement("roleImpliesAttribute")
public class RoleImpliesAttribute extends de.fu.bakery.orm.java.GenericRelationship {
	...
	RoleImpliesAttribute(RelationManager manager, Role subject, Attribute object, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	...
	RoleImpliesAttribute(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			ref_role = result.getInt("role");
	...
	@Override
	public RoleImpliesAttribute create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	public void pushChanges() throws de.fu.bakery.orm.java.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.bakery.orm.java.OutdatedRecordException("\"scetris\".\"roleImpliesAttribute\"" + '#' + id());
			}
			_timekey = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.bakery.orm.java.DatabaseException(query, e);
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "default", serial = true, nullable = true)
	...
	public RoleImpliesAttribute setRole(Role value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_role, value._id) == 0) return this;
		changed_role = true;
		ref_role = value._id;
		fetched_role = true;
		_role = value;
...
@Override
	...
	public RoleImpliesAttribute setDefault(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_default, value) == 0) return this;
