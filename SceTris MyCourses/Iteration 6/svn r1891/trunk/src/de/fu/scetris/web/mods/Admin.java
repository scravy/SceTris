...
import static de.fu.bakery.orm.java.filters.Filters.unEq;
...
import de.fu.scetris.web.mods.forms.DeleteRoles;
import de.fu.scetris.web.mods.forms.DeleteUsers;
import de.fu.scetris.web.mods.forms.EditAcademicTerm;
import de.fu.scetris.web.mods.forms.EditBuilding;
import de.fu.scetris.web.mods.forms.EditDepartment;
import de.fu.scetris.web.mods.forms.EditUser;
import de.fu.scetris.web.mods.forms.EditYear;
import de.fu.scetris.web.mods.forms.NewAcademicTerm;
import de.fu.scetris.web.mods.forms.NewAttribute;
import de.fu.scetris.web.mods.forms.NewBuilding;
import de.fu.scetris.web.mods.forms.NewCourseAttribute;
import de.fu.scetris.web.mods.forms.NewDepartment;
import de.fu.scetris.web.mods.forms.NewFeature;
import de.fu.scetris.web.mods.forms.NewPrivilege;
import de.fu.scetris.web.mods.forms.NewPrivileges;
import de.fu.scetris.web.mods.forms.NewRole;
import de.fu.scetris.web.mods.forms.NewRoom;
import de.fu.scetris.web.mods.forms.NewUser;
import de.fu.scetris.web.mods.forms.NewYear;
import de.fu.scetris.web.mods.forms.QuickEditBuildings;
import de.fu.scetris.web.mods.forms.QuickEditDepartments;
import de.fu.scetris.web.mods.forms.SchedulingControl;
 ...
 * <p>
 * The sole purpose of this module is to show option-panes and forms, the actual
 * logic is contained in {@see UserMgmt}, {@see ImportExport}, ...
 */
...
public class Admin extends FriggModule<RelationManager> {
	...
	public void schedulerPanel(final SchedulingControl $role) throws Exception {
		...
		if (schedulerController.isReady()) {
			put("status", "ready");
		} else if ($role.schedulerstatus.equals("stopping")) {
			put("status", "stopping");
		} else if ($role.schedulerstatus.equals("running")) {
			put("status", "running");

			put("scheduleScore",
					schedulerController.getCurrentSchedulingScore());
