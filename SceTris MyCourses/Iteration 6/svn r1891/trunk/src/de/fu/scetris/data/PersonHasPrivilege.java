/* PersonHasPrivilege.java / 2011-01-15+01:00
...
public class PersonHasPrivilege extends de.fu.bakery.orm.java.GenericRelationship {
	...
	@Override
	public PersonHasPrivilege create() throws de.fu.bakery.orm.java.DatabaseException {
...
@Override
	...
	public PersonHasPrivilege setBecauseOfRole(Boolean value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_becauseOfRole, value) == 0) return this;
