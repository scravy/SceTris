/* RoleImpliesPrivilege.java / 2011-01-15+01:00
...
public class RoleImpliesPrivilege extends de.fu.bakery.orm.java.GenericRelationship {
	...
	@Override
	public RoleImpliesPrivilege create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	public RoleImpliesPrivilege setPrivilege(Privilege value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_privilege, value._id) == 0) return this;
...
@Override
	...
	public RoleImpliesPrivilege setTarget(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_target, value) == 0) return this;
		changed_target = true;
		_target = value;
		return this;
	}
