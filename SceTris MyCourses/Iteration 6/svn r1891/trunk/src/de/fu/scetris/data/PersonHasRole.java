/* PersonHasRole.java / 2011-01-15+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Relationship(name = "personHasRole", subject = Person.class, object = Role.class)
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"personHasRole\"", requiredSqlCols = {})
@de.fu.weave.xml.annotation.XmlElement("personHasRole")
public class PersonHasRole extends de.fu.bakery.orm.java.GenericRelationship {
	...
	PersonHasRole(RelationManager manager, Person subject, Role object, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	...
	PersonHasRole(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
			ref_user = result.getInt("user");
			...
			this.object_refid = result.getInt("\"role\"");
	...
	@Override
	public Role object() throws de.fu.bakery.orm.java.DatabaseException {
		if (object == null) {
	...
	@Override
	public PersonHasRole create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	public void pushChanges() throws de.fu.bakery.orm.java.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.bakery.orm.java.OutdatedRecordException("\"scetris\".\"personHasRole\"" + '#' + id());
			}
			_mtime = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.bakery.orm.java.DatabaseException(query, e);
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "role", use = "object", ref = Role.class)
