/* CourseRecommendedForYear.java / 2011-01-15+01:00
...
public class CourseRecommendedForYear extends de.fu.bakery.orm.java.GenericRelationship {
	...
	@Override
	public CourseRecommendedForYear create() throws de.fu.bakery.orm.java.DatabaseException {
	...
	public CourseRecommendedForYear setYear(Year value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_year, value._id) == 0) return this;
		changed_year = true;
		ref_year = value._id;
		fetched_year = true;
		_year = value;
