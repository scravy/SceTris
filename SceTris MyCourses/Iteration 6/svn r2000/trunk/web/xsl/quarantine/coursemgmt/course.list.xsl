...
<xsl:template mode="content" match="vars:meta">
	...
	<h1><a href="{/vars:meta/@module-path}">↤</a> Courses (<a href="{/vars:meta/@module-path}/coursenew">new</a>)</h1>
	
	<table cellpadding="5px">
		<tr>
		<th>Edit</th><th>Course</th>
		</tr>
...
<xsl:template match="item:data">
	...
	<td align="center" style="padding-bottom:7px;">
		<a href="{/vars:meta/@module-path}/courseedit/?data={@id}" class="list edit">⚒</a>
	</td>
	<td>
