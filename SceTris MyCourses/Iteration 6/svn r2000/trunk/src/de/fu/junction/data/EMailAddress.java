...
public class EMailAddress implements Serializable {
	private static final long serialVersionUID = 6739001280767961579L;
	public static final String MAILBOX_REGEX = "^([a-zA-Z0-9\\!\\#\\$\\%\\&\'\\*\\+\\-\\/\\=\\?\\^_`\\{\\|\\}~\\.]+|\"[a-zA-Z0-9\\!\\#\\$\\%\\&\'\\*\\+\\-\\/\\=\\?\\^_`\\{\\|\\}~\\.\\(\\)\\<\\>\\[\\]\\:;@\\\\,]+\")$";
	public static final String HOSTNAME_REGEX = "^([a-zA-Z0-9\\-]+\\.)+[a-zA-Z]{2,}$";
	...
	public EMailAddress(String $eMailAddress) throws InvalidSyntaxException {
		...
		if ($at < 0) throw new MalformedEMailAddressException("Must contain an at");
	...
	public boolean equals(final Object $obj) {
		...
		} else if (!$hostname.toLowerCase().equals(other.$hostname.toLowerCase())) return false;
		if ($mailbox == null) {
			if (other.$mailbox != null) return false;
		} else if (!$mailbox.equals(other.$mailbox)) return false;
		return true;
	}
