...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"Day\"", requiredSqlCols = {"name"})
...
public class Day extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	 ...
	 */
	@Override
	public Day create() throws de.fu.weave.orm.DatabaseException {
