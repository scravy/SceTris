...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"Room\"", requiredSqlCols = {"number", "building"})
...
public class Room extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		public static final long serialVersionUID = 4483107L;
		...
		@de.fu.weave.Form.Field("number") @de.fu.weave.Form.Required
		@de.fu.weave.Form.ActiveValidator("number$validator")
		@de.fu.weave.Form.ActiveConverter("number$converter")
		public String number;
		
		@de.fu.weave.Form.Pos(5)
		@de.fu.weave.Form.Field("building") @de.fu.weave.Form.Required
		@de.fu.weave.Form.ActiveValidator("building$validator")
		@de.fu.weave.Form.ActiveConverter("building$converter")
		@de.fu.weave.Form.Alternatives("building$alternatives")
		@de.fu.weave.Form.FormControl(de.fu.weave.Form.Control.ALTERNATIVES)
		public int building;
		
		public java.util.Map<Integer,java.lang.String> building$alternatives = new java.util.TreeMap<Integer,java.lang.String>();
	 ...
	 */
	@Override
	public Room create() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Timeslot> objectsOfRoomPrefersTimeslot() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<RoomPrefersTimeslot> whereSubjectOfRoomPrefersTimeslot() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Feature> objectsOfRoomProvidesFeature() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<RoomProvidesFeature> whereSubjectOfRoomProvidesFeature() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<CourseElementInstance> subjectsOfElementInstancePrefersRoom() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementInstancePrefersRoom> whereObjectOfElementInstancePrefersRoom() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<CourseElementInstance> subjectsOfElementInstanceTakesPlaceInRoom() throws de.fu.weave.orm.DatabaseException {
		String query = "SELECT * FROM " + "\"scetris\".\"CourseElementInstance\""
			+ " WHERE \"id\" IN (SELECT \"element_instance\" FROM "
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementInstanceTakesPlaceInRoom> whereObjectOfElementInstanceTakesPlaceInRoom() throws de.fu.weave.orm.DatabaseException {
	...
	@de.fu.weave.orm.annotation.Attribute(name = "number", serial = true)
	...
	@de.fu.weave.orm.annotation.Attribute(name = "building", serial = true, ref = Building.class)
...
@Override
	...
	public Room setBuilding(Building value) {
		...
		if (de.fu.weave.orm.GenericRelationManager.compareValues(ref_building, value._id) == 0) return this;
