/* CourseElement.java / 2011-02-01+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"CourseElement\"", requiredSqlCols = {"part_of", "duration"})
...
public class CourseElement extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Feature> objectsOfElementRequiresFeature() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementRequiresFeature> whereSubjectOfElementRequiresFeature() throws de.fu.weave.orm.DatabaseException {
...
@Override
	...
	public CourseElement setPartOf(Course value) {
		...
		if (de.fu.weave.orm.GenericRelationManager.compareValues(ref_partOf, value._id) == 0) return this;
		changed_partOf = true;
