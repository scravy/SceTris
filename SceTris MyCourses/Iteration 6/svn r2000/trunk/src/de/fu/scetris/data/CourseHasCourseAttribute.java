/* CourseHasCourseAttribute.java / 2011-02-01+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"courseHasCourseAttribute\"", requiredSqlCols = {"editor"})
...
public class CourseHasCourseAttribute extends de.fu.weave.orm.GenericRelationship {
	 ...
	 * @since Iteration2
	 */
	public CourseHasCourseAttribute setEditor(Person value) {
		if (manager.isNull(value)) {
			throw new java.lang.IllegalArgumentException("editor is not nullable, null given");
		}
		
		if (de.fu.weave.orm.GenericRelationManager.compareValues(ref_editor, value._id) == 0) return this;
		changed_editor = true;
	 ...
	 * @since Iteration3
	 */
	public CourseHasCourseAttribute clearValue() {
		if (_value == null) {
			return this;
		}
		_value = null;
