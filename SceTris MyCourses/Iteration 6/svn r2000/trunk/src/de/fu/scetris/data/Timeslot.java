/* Timeslot.java / 2011-02-01+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"Timeslot\"", requiredSqlCols = {"day", "startingTime"})
...
public class Timeslot extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	 ...
	 */
	@Override
	public Timeslot create() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<CourseElementInstance> subjectsOfElementInstancePrefersTimeslot() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementInstancePrefersTimeslot> whereObjectOfElementInstancePrefersTimeslot() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Person> subjectsOfPersonPrefersTimeslot() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<PersonPrefersTimeslot> whereObjectOfPersonPrefersTimeslot() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Room> subjectsOfRoomPrefersTimeslot() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<RoomPrefersTimeslot> whereObjectOfRoomPrefersTimeslot() throws de.fu.weave.orm.DatabaseException {
...
@Override
	...
	public Timeslot setDay(Day value) {
		...
		if (de.fu.weave.orm.GenericRelationManager.compareValues(ref_day, value._id) == 0) return this;
		changed_day = true;
		ref_day = value._id;
		fetched_day = true;
		_day = value;
	...
	public Timeslot setStartingTime(java.sql.Time value) {
		...
		if (de.fu.weave.orm.GenericRelationManager.compareValues(_startingTime, value) == 0) return this;
