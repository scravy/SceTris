...
public class SchedulerManagerTest extends SchedulerTest {
	...
	public void testGetScheduleScore() throws Exception {
		...
		Assert.assertEquals(
				1,
				score.getCourseToRoomOverlap()
						.get(courseElementInstanceList.get(0)).size());
		Assert.assertTrue(score.getCourseToRoomOverlap()
				.get(courseElementInstanceList.get(0))
				.contains(courseElementInstanceList.get(4)));

		Assert.assertEquals(
				1,
				score.getCourseToRoomOverlap()
						.get(courseElementInstanceList.get(4)).size());
		Assert.assertTrue(score.getCourseToRoomOverlap()
				.get(courseElementInstanceList.get(4))
	...
	public void testGetScheduleScoreWithChange() throws Exception {
		...
		Assert.assertEquals(0, score.getCourseToRoomOverlap().size());
		Assert.assertEquals(0, score.getCourseToRoomOverlap().size());
	}
