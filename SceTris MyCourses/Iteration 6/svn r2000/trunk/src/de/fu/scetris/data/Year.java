...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"Year\"", requiredSqlCols = {"name"})
@de.fu.weave.xml.annotation.XmlElement("Year")
public class Year extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	...
	public abstract static class Form extends de.fu.scetris.data.formsupport.AbstractForm {
		public static final long serialVersionUID = 4955055L;
		...
		public Form setValues(Year $object) {
	 ...
	 */
	@Override
	public Year create() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Course> subjectsOfCourseRecommendedForYear() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<CourseRecommendedForYear> whereObjectOfCourseRecommendedForYear() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration2
	 */
	public Year setName(String value) {
