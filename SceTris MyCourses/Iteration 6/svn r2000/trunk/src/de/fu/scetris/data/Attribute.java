/* Attribute.java / 2011-02-01+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"Attribute\"", requiredSqlCols = {"name"})
@de.fu.weave.xml.annotation.XmlElement("Attribute")
public class Attribute extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	 ...
	 */
	@Override
	public Attribute create() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Person> subjectsOfPersonHasAttribute() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<PersonHasAttribute> whereObjectOfPersonHasAttribute() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Role> subjectsOfRoleImpliesAttribute() throws de.fu.weave.orm.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<RoleImpliesAttribute> whereObjectOfRoleImpliesAttribute() throws de.fu.weave.orm.DatabaseException {
