/* PersonPrefersTimeslot.java / 2010-11-04+01:00
...
@de.fu.weave.orm.annotation.Relation("\"scetris\".\"personPrefersTimeslot\"")
...
public class PersonPrefersTimeslot extends de.fu.weave.orm.GenericRelationship {
	...
	public void create() throws de.fu.weave.orm.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"personPrefersTimeslot\"" + " (\"user\", \"timeslot\", \"priority\")"
			+ " VALUES (?, ?, ?);";
		try {
