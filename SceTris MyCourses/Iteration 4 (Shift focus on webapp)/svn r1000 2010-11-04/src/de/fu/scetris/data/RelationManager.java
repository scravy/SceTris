/* RelationManager.java / 2010-11-04+01:00
...
public class RelationManager extends de.fu.weave.orm.GenericRelationManager {
	...
	public boolean install() throws de.fu.weave.orm.DatabaseException {
		try {
			...
			stmt.executeUpdate("CREATE TABLE \"scetris\".\"roleImpliesPrivilege\" ( 	\"role\" INTEGER NOT NULL, 	\"privilege\" INTEGER NOT NULL, 	\"timekey\" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 	\"target\" VARCHAR NOT NULL DEFAULT '', 	PRIMARY KEY (\"role\", \"privilege\", \"target\") );");
			...
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35820461 ON \"scetris\".\"AcademicTerm\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35820618 ON \"scetris\".\"Attribute\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35820748 ON \"scetris\".\"Building\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35820755 ON \"scetris\".\"Building\" (\"address\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35820917 ON \"scetris\".\"Course\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35821104 ON \"scetris\".\"CourseAttribute\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35821663 ON \"scetris\".\"CourseElementType\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35821977 ON \"scetris\".\"Day\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822119 ON \"scetris\".\"Department\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822235 ON \"scetris\".\"Feature\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822350 ON \"scetris\".\"Group\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822883 ON \"scetris\".\"Person\" (\"email_address\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822890 ON \"scetris\".\"Person\" (\"login_name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822898 ON \"scetris\".\"Person\" (\"student_id\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35822905 ON \"scetris\".\"Person\" (\"staff_id\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823019 ON \"scetris\".\"Privilege\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823511 ON \"scetris\".\"ProposedScheduling\" (\"element_instance\", \"timeslot\", \"room\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823634 ON \"scetris\".\"Role\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35823798 ON \"scetris\".\"Room\" (\"name\", \"building\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35824056 ON \"scetris\".\"Year\" (\"name\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35824765 ON \"scetris\".\"elementInstanceTakesPlaceInRoom\" (\"room\", \"timeslot\"); ");
			stmt.executeUpdate("CREATE UNIQUE INDEX uniq_id35826395 ON \"scetris\".\"personTakesPartInElementInstance\" (\"user\", \"timeslot\"); ");
			...
			stmt.executeUpdate("DELETE FROM \"scetris\".\"Person\" WHERE \"login_name\"='super';");
			stmt.executeUpdate("DROP LANGUAGE IF EXISTS plpgsql CASCADE;");
			stmt.executeUpdate("CREATE LANGUAGE plpgsql;");
			stmt.executeUpdate("INSERT INTO \"scetris\".\"Person\" (first_name, last_name, login_name, login_password, is_superuser) VALUES ('super','super','super','1b3231655cebb7a1f783eddf27d254ca',TRUE);");
	 ...
	 * @since Iteration4
	 */
	public void dropSchema() throws de.fu.weave.orm.DatabaseException {
