/* PersonBelongsToGroup.java / 2010-11-04+01:00
...
@de.fu.weave.orm.annotation.Relation("\"scetris\".\"personBelongsToGroup\"")
...
public class PersonBelongsToGroup extends de.fu.weave.orm.GenericRelationship {
	...
	@Override
	public Group object() throws de.fu.weave.orm.DatabaseException {
		if (object == null) {
	...
	public void create() throws de.fu.weave.orm.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"personBelongsToGroup\"" + " (\"user\", \"group\", \"ctime\", \"mtime\", \"created_by\")"
			+ " VALUES (?, ?, ?, ?, ?);";
		try {
	...
	@de.fu.weave.orm.annotation.Attribute(name = "user", ref = Person.class)
	...
	@de.fu.weave.orm.annotation.Attribute(name = "group", ref = Group.class)
