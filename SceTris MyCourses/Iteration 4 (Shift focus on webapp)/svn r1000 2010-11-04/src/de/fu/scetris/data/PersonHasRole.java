/* PersonHasRole.java / 2010-11-04+01:00
...
@de.fu.weave.orm.annotation.Relation("\"scetris\".\"personHasRole\"")
...
public class PersonHasRole extends de.fu.weave.orm.GenericRelationship {
	...
	public void create() throws de.fu.weave.orm.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"personHasRole\"" + " (\"user\", \"role\", \"ctime\", \"mtime\", \"created_by\")"
			+ " VALUES (?, ?, ?, ?, ?);";
		try {
	...
	@de.fu.weave.orm.annotation.Attribute(name = "role", ref = Role.class)
