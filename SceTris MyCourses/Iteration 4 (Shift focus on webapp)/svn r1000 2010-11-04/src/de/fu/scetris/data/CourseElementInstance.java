 ...
 * <p>
 * 
 * A CourseElementInstance is created within a Program belonging to a CourseInstance. It is a
 * CourseElement actually taking place.
 * 
 * @since Iteration2
 */
...
public class CourseElementInstance extends de.fu.weave.orm.GenericEntity implements
		de.fu.weave.orm.Entity {
	 ...
	 * <p>
	 * 
	 * An artificial key introduced to allow easy referencing of an entity. Once an id has been set
	 * it won’t change, therfore avoiding update anomalies.
	 * 
	 * @since Iteration2
	 */
	int _id;
	 ...
	 * @since Iteration2
	 */
	CourseElementInstance(final RelationManager manager, final boolean full,
			final CourseInstance _courseInstance, final CourseElement _courseElement,
			final Timeslot _startingTimeslot, final int _duration, final boolean _schedulableLesson) {
		if (!full) {
			this.manager = null;
		} else {
			this.manager = manager;
			this._courseInstance = _courseInstance;
			ref_courseInstance = _courseInstance.id();
			fetched_courseInstance = true;
			this._courseElement = _courseElement;
			ref_courseElement = _courseElement.id();
	...
	/**
	 * Constructs the entity CourseElementInstance and initializes only the required attributes
	 * (i.e. the fields which are neither nullable nor have a default value)
	 * 
	 * @param _courseInstance
	 *            The Course this Course Element Instance is part of.
	 * 
	 ...
	 * @since Iteration2
	 */
	CourseElementInstance(final RelationManager manager, final CourseInstance _courseInstance,
			final CourseElement _courseElement, final int _duration) {
		this.manager = manager;
		this._courseInstance = _courseInstance;
		ref_courseInstance = _courseInstance.id();
		fetched_courseInstance = true;
	 ...
	 * <p>
	 * This Constructor is not publicly available as it should be used by {@link RelationManager}
	 * only.
	 * 
	 * @param result
	 *            The SQL ResultSet
	 * @since Iteration2
	 */
	CourseElementInstance(final RelationManager manager, final java.sql.ResultSet result)
	...
	public int compareTo(final CourseElementInstance entity) {
		if (entity == null) {
			return -1;
		}
		if (equals(entity)) {
		...
		return GenericRelationManager.compareIds(id(), entity.id());
	}

	@Override
	public int compareTo(final de.fu.weave.orm.Entity entity) {
		if (entity == null) {
			return -1;
		}
...
/**
	...
	public void create() throws de.fu.weave.orm.DatabaseException {
		String query =
				"INSERT INTO "
						+ "\"scetris\".\"CourseElementInstance\""
						+ " (\"course_instance\" , \"course_element\" , \"starting_timeslot\" , \"duration\" , \"schedulable_lesson\" )"
						+ " VALUES (?, ?, ?, ?, ?) RETURNING id;";
		try {
	...
	public boolean equals(final CourseElementInstance entity) {
		if (entity == null) {
			return false;
		}
		return entity.id() == id();
	...
	@de.fu.weave.orm.annotation.Attribute(name = "course_element",
										  serial = true,
										  ref = CourseElement.class)
	...
	@de.fu.weave.orm.annotation.Attribute(name = "course_instance",
										  serial = true,
										  ref = CourseInstance.class)
	...
	@de.fu.weave.orm.annotation.Attribute(name = "starting_timeslot",
										  serial = true,
										  nullable = true,
										  ref = Timeslot.class)
	...
	@Override
	public int hashCode() {
		return GenericRelationManager._hashCode(_id);
	}
	...
	/**
	 * Retrieves the first java-object which is related to this java-object as via
	 * ElementInstancePrefersRoom.
	 * <p>
	 * This is the subject of ElementInstancePrefersRoom.
	 * 
	 * @return The object regarding ElementInstancePrefersRoom where this (the java-object you call
	 *         objectsOfElementInstancePrefersRoom on) is the subject.
	 * @since Iteration3
	 */
	 ...
	 * 
	 * @return The object regarding ElementInstancePrefersTimeslot where this (the java-object you
	 *         call objectsOfElementInstancePrefersTimeslot on) is the subject.
	 * @since Iteration3
	 */
	 ...
	 * 
	 * @return The object regarding ElementInstanceRequiresFeature where this (the java-object you
	 *         call objectsOfElementInstanceRequiresFeature on) is the subject.
	 * @since Iteration3
	 */
	 ...
	 * 
	 * @return The object regarding ElementInstanceTakesPlaceInRoom where this (the java-object you
	 *         call objectsOfElementInstanceTakesPlaceInRoom on) is the subject.
	 * @since Iteration3
	 */
	...
	/**
	 * Retrieves all objects which are related to this object as via ElementInstancePrefersRoom. If
	 * you know that there will be only 1:1 relationships of the type ElementInstancePrefersRoom,
	 * {@link #objectOfElementInstancePrefersRoom} is what you are looking for.
	 * <p>
	 * This is the subject of ElementInstancePrefersRoom.
	 * 
	 * @return The object regarding ElementInstancePrefersRoom where this (the java-object you call
	 ...
	 * @since Iteration3
	 */
	public java.util.Collection<Room> objectsOfElementInstancePrefersRoom()
			throws de.fu.weave.orm.DatabaseException {
	...
	/**
	 * Retrieves all objects which are related to this object as via ElementInstancePrefersTimeslot.
	 * If you know that there will be only 1:1 relationships of the type
	 * ElementInstancePrefersTimeslot, {@link #objectOfElementInstancePrefersTimeslot} is what you
	 * are looking for.
	 * <p>
	 * This is the subject of ElementInstancePrefersTimeslot.
	 * 
	 ...
	 * @since Iteration3
	 */
	public java.util.Collection<Timeslot> objectsOfElementInstancePrefersTimeslot()
			throws de.fu.weave.orm.DatabaseException {
	...
	/**
	 * Retrieves all objects which are related to this object as via ElementInstanceRequiresFeature.
	 * If you know that there will be only 1:1 relationships of the type
	 * ElementInstanceRequiresFeature, {@link #objectOfElementInstanceRequiresFeature} is what you
	 * are looking for.
	 * <p>
	 * This is the subject of ElementInstanceRequiresFeature.
	 * 
	 ...
	 * @since Iteration3
	 */
	public java.util.Collection<Feature> objectsOfElementInstanceRequiresFeature()
			throws de.fu.weave.orm.DatabaseException {
	...
	/**
	 * Retrieves all objects which are related to this object as via
	 * ElementInstanceTakesPlaceInRoom. If you know that there will be only 1:1 relationships of the
	 * type ElementInstanceTakesPlaceInRoom, {@link #objectOfElementInstanceTakesPlaceInRoom} is
	 ...
	 * @since Iteration3
	 */
	public java.util.Collection<Room> objectsOfElementInstanceTakesPlaceInRoom()
			throws de.fu.weave.orm.DatabaseException {
		String query = "SELECT * FROM " + "\"scetris\".\"Room\""
				+ " WHERE id IN (SELECT room FROM "
	...
	public void pushChanges() throws de.fu.weave.orm.DatabaseException {
		String query =
				"UPDATE "
						+ "\"scetris\".\"CourseElementInstance\""
						+ " SET \"course_instance\" = ?, \"course_element\" = ?, \"starting_timeslot\" = ?, \"duration\" = ?, \"schedulable_lesson\" = ? WHERE id = ?;";
		try {
			java.sql.PreparedStatement stmt =
					manager.connectionManager.getConnection().prepareStatement(query);
			int i = 1;
	 ...
	 * @since Iteration2
	 */
	public void setCourseElement(final CourseElement value) {
	 ...
	 * @since Iteration2
	 */
	public void setCourseInstance(final CourseInstance value) {
	 ...
	 * @since Iteration2
	 */
	public void setSchedulableLesson(final boolean value) {
	 ...
	 * @since Iteration2
	 */
	public void setStartingTimeslot(final Timeslot value) {
		if (value == null) {
			_startingTimeslot = null;
			ref_startingTimeslot = null;
			return;
	 ...
	 * @since Iteration2
	 */
	public void setTimekey(final java.sql.Timestamp value) {
	 ...
	 * 
	 * @return The subject regarding PersonTakesPartInElementInstance where this (the java-object
	 *         you call subjectsOfPersonTakesPartInElementInstance on) is the object.
	 * @since Iteration3
	 */
	...
	/**
	 * Retrieves all java-objects which are related to this java-object as via
	 * PersonTakesPartInElementInstance. If you know that there will be only 1:1 relationships of
	 * the type PersonTakesPartInElementInstance, {@link #subjectOfPersonTakesPartInElementInstance}
	 * is what you are looking for.
	 * <p>
	 * This is the object of PersonTakesPartInElementInstance.
	 * 
	 * @return A Collection of subjects regarding PersonTakesPartInElementInstance where this (the
	 *         java-object you call subjectsOfPersonTakesPartInElementInstance on) is the object.
	 * @since Iteration3
	 */
	public java.util.Collection<Person> subjectsOfPersonTakesPartInElementInstance()
			throws de.fu.weave.orm.DatabaseException {
	...
	public String toString() {
		return "CourseElementInstance: \"" + _id + "\" (#" + _id + ")";
	}

	/**
	 * Retrieves the actual Relationship-Object in which this is the object of the relationship.
	 * 
	 * @since Iteration3
	 */
	public java.util.Collection<PersonTakesPartInElementInstance> whereObjectOfPersonTakesPartInElementInstance()
			throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			stmt.setInt(1, id());
			java.sql.ResultSet result = stmt.executeQuery();
			java.util.Collection<PersonTakesPartInElementInstance> ret =
					new java.util.ArrayList<PersonTakesPartInElementInstance>();
			while (result.next()) {
	...
	/**
	 * Retrieves the actual Relationship-Objects in which this is the subject of the relationship.
	 * 
	 * @since Iteration3
	 */
	public java.util.Collection<ElementInstancePrefersRoom> whereSubjectOfElementInstancePrefersRoom()
			throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			stmt.setInt(1, id());
			java.sql.ResultSet result = stmt.executeQuery();
			java.util.Collection<ElementInstancePrefersRoom> ret =
					new java.util.ArrayList<ElementInstancePrefersRoom>();
			while (result.next()) {
	 ...
	 * @since Iteration3
	 */
	public java.util.Collection<ElementInstancePrefersTimeslot> whereSubjectOfElementInstancePrefersTimeslot()
			throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			stmt.setInt(1, id());
			java.sql.ResultSet result = stmt.executeQuery();
			java.util.Collection<ElementInstancePrefersTimeslot> ret =
					new java.util.ArrayList<ElementInstancePrefersTimeslot>();
			while (result.next()) {
	 ...
	 * @since Iteration3
	 */
	public java.util.Collection<ElementInstanceRequiresFeature> whereSubjectOfElementInstanceRequiresFeature()
			throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			stmt.setInt(1, id());
			java.sql.ResultSet result = stmt.executeQuery();
			java.util.Collection<ElementInstanceRequiresFeature> ret =
					new java.util.ArrayList<ElementInstanceRequiresFeature>();
			while (result.next()) {
	 ...
	 * @since Iteration3
	 */
	public java.util.Collection<ElementInstanceTakesPlaceInRoom> whereSubjectOfElementInstanceTakesPlaceInRoom()
			throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			stmt.setInt(1, id());
			java.sql.ResultSet result = stmt.executeQuery();
			java.util.Collection<ElementInstanceTakesPlaceInRoom> ret =
					new java.util.ArrayList<ElementInstanceTakesPlaceInRoom>();
			while (result.next()) {
