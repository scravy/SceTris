/* Configuration.java / 2010-11-04+01:00
...
public class Configuration extends de.fu.weave.orm.GenericEntity implements de.fu.weave.orm.Entity  {
	...
	@de.fu.weave.orm.annotation.Attribute(name = "key", serial = true, primary = true)
	...
	public void setKey(String value) {
		...
		if (manager.isNull(value)) {
			throw new java.lang.IllegalArgumentException("key is not nullable, null given");
		}
		changed_key = true;
		_key = value;
	}
