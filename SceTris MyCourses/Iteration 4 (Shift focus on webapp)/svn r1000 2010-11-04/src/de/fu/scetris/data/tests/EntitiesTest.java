...
public class EntitiesTest extends de.fu.weave.tests.DatabaseTestSkeleton {
	...
	public void createTwo() throws DatabaseException {
		...
		System.out.println(new String(manager.getPerson(id).getFirstName()));
	}
	...
	public void twoStepCreate() throws DatabaseException {
		...
		person.setCtime(new Timestamp(System.currentTimeMillis()));
		person.setMtime(new Timestamp(System.currentTimeMillis()));
		person.create();
