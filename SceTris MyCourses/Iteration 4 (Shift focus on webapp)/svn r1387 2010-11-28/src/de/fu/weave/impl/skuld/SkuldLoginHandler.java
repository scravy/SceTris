 ...
 * @since Iteration2
 */
public class SkuldLoginHandler<R extends RelationManager> extends SpecialAction<R> {

	SkuldLoginHandler(final SkuldController<R> parent) {
		super(parent);
	}
	...
	void doIt(final Map<String,String[]> parameters) throws SpecialActionException {
		...
		try {
			// FIXME: It should not be getPerson() but something generic
			users =
