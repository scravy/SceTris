...
public class ScheduleImpl implements Schedule, Comparable<Schedule> {
	...
	/**
	 * Schedules a course into the current schedule by a specified room and a specified time slot.
	 * The course is added to the map in order to get the starting time slot and is added as long as
	 * its duration is in the room-time-course slots.
	 * 
	 * @param course
	 ...
	 */
	public void addCourse(final CourseElementInstance course, final int roomIndex,
	...
	/**
	 * Initializes the time-space-slots of Schedule in respect to the current scheduled
	...
	@Override
	public void setSatisfiedHardConstraintCount(final int satisfiedHardConstraintCount) {
		SatisfiedHardConstraintCount = satisfiedHardConstraintCount;
	}

	@Override
	public void setSatisfiedSoftConstraintCount(final int satisfiedSoftConstraintCount) {
