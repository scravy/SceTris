/* Department.java / 2010-11-27+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Entity(name = "Department")
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"Department\"", requiredSqlCols = {"name"})
@de.fu.weave.xml.annotation.XmlElement("Department")
public class Department extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	...
	public static class Stub {
		...
		public int Id;public String Name;public java.sql.Timestamp Timekey;public Department SuperordinateDepartment;
	}
	...
	public Stub asStub() {
		...
		stub.SuperordinateDepartment = _superordinateDepartment;
	 ...
	 * @since Iteration2
	 */
	Department(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "superordinate_department", serial = true, nullable = true, ref = Department.class)
	public Department getSuperordinateDepartment() throws de.fu.bakery.orm.java.DatabaseException {
		if (ref_superordinateDepartment == null) {
			return null;
		}
...
@Override
	...
	public void setSuperordinateDepartment(Department value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_superordinateDepartment, value._id) == 0) return;
