/* CourseInstance.java / 2010-11-27+01:00
...
public class CourseInstance extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	...
	public static class Stub {
		...
		public int Id;public java.sql.Timestamp Timekey;public Program Program;public Course InstanceOf;public java.sql.Date Start;public java.sql.Date End;public Person MainLecturer;
	}
	...
	public Stub asStub() {
		...
		stub.Program = _program;
		stub.InstanceOf = _instanceOf;
		stub.Start = _start;
		stub.End = _end;
		stub.MainLecturer = _mainLecturer;
...
@Override
	...
	public void setProgram(Program value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_program, value._id) == 0) return;
	...
	public void setInstanceOf(Course value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_instanceOf, value._id) == 0) return;
	...
	public void setMainLecturer(Person value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_mainLecturer, value._id) == 0) return;
