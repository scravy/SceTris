/* CourseElementInstance.java / 2010-11-27+01:00
 ...
 * @since Iteration2
 */
@de.fu.bakery.orm.java.annotation.Entity(name = "CourseElementInstance")
@de.fu.bakery.orm.java.annotation.Relation(name = "\"scetris\".\"CourseElementInstance\"", requiredSqlCols = {"course_instance", "course_element", "duration"})
@de.fu.weave.xml.annotation.XmlElement("CourseElementInstance")
public class CourseElementInstance extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	...
	public static class Stub {
		...
		public int Id;public java.sql.Timestamp Timekey;public CourseInstance CourseInstance;public CourseElement CourseElement;public Timeslot StartingTimeslot;public int Duration;public boolean SchedulableLesson;
	}
	...
	public Stub asStub() {
		...
		stub.CourseInstance = _courseInstance;
		stub.CourseElement = _courseElement;
		stub.StartingTimeslot = _startingTimeslot;
		stub.Duration = _duration;
		stub.SchedulableLesson = _schedulableLesson;
	 ...
	 * @since Iteration2
	 */
	CourseElementInstance(RelationManager manager, java.sql.ResultSet result) throws de.fu.bakery.orm.java.DatabaseException {
	...
	public void create() throws de.fu.bakery.orm.java.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"CourseElementInstance\"" + " (\"course_instance\", \"course_element\", \"starting_timeslot\", \"duration\", \"schedulable_lesson\", \"timekey\")"
			+ " VALUES (?, ?, ?, ?, ?, ?) RETURNING id;";
		timekey(true);
		try {
	 ...
	 * @since Iteration3
	 */
	public Room objectOfElementInstancePrefersRoom() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Room> objectsOfElementInstancePrefersRoom() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementInstancePrefersRoom> whereSubjectOfElementInstancePrefersRoom() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public Timeslot objectOfElementInstancePrefersTimeslot() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Timeslot> objectsOfElementInstancePrefersTimeslot() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementInstancePrefersTimeslot> whereSubjectOfElementInstancePrefersTimeslot() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public Feature objectOfElementInstanceRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Feature> objectsOfElementInstanceRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementInstanceRequiresFeature> whereSubjectOfElementInstanceRequiresFeature() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public Room objectOfElementInstanceTakesPlaceInRoom() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Room> objectsOfElementInstanceTakesPlaceInRoom() throws de.fu.bakery.orm.java.DatabaseException {
		String query = "SELECT * FROM " + "\"scetris\".\"Room\""
			+ " WHERE id IN (SELECT room FROM "
	 ...
	 * @since Iteration3
	 */
	public java.util.List<ElementInstanceTakesPlaceInRoom> whereSubjectOfElementInstanceTakesPlaceInRoom() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public Person subjectOfPersonTakesPartInElementInstance() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<Person> subjectsOfPersonTakesPartInElementInstance() throws de.fu.bakery.orm.java.DatabaseException {
	 ...
	 * @since Iteration3
	 */
	public java.util.List<PersonTakesPartInElementInstance> whereObjectOfPersonTakesPartInElementInstance() throws de.fu.bakery.orm.java.DatabaseException {
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "course_instance", serial = true, ref = CourseInstance.class)
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "course_element", serial = true, ref = CourseElement.class)
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "starting_timeslot", serial = true, nullable = true, ref = Timeslot.class)
	public Timeslot getStartingTimeslot() throws de.fu.bakery.orm.java.DatabaseException {
		if (ref_startingTimeslot == null) {
			return null;
		}
	...
	@de.fu.bakery.orm.java.annotation.Attribute(name = "schedulable_lesson", serial = true)
...
@Override
	...
	public void setStartingTimeslot(Timeslot value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_startingTimeslot, value._id) == 0) return;
	...
	public void setDuration(int value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_duration, value) == 0) return;
	...
	public void setSchedulableLesson(boolean value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_schedulableLesson, value) == 0) return;
