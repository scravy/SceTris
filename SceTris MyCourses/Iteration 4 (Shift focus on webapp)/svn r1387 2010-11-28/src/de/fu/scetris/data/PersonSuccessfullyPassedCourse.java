/* PersonSuccessfullyPassedCourse.java / 2010-11-27+01:00
...
@Override
	...
	public void setGrade(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_grade, value) == 0) return;
		changed_grade = true;
		_grade = value;
	}
	...
	public void setNotes(String value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_notes, value) == 0) return;
		changed_notes = true;
		_notes = value;
	}
