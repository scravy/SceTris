/* Timeslot.java / 2010-11-27+01:00
...
public class Timeslot extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	...
	public static class Stub {
		...
		public int Id;public java.sql.Timestamp Timekey;public Day Day;public java.sql.Time StartingTime;
	}
	...
	public Stub asStub() {
		...
		stub.Day = _day;
		stub.StartingTime = _startingTime;
...
@Override
	...
	public void setDay(Day value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_day, value._id) == 0) return;
		changed_day = true;
		ref_day = value._id;
		fetched_day = true;
		_day = value;
	...
	public void setStartingTime(java.sql.Time value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(_startingTime, value) == 0) return;
