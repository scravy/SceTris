/* CourseElement.java / 2010-11-27+01:00
...
public class CourseElement extends de.fu.bakery.orm.java.GenericEntity implements de.fu.bakery.orm.java.Entity  {
	...
	public static class Stub {
		...
		public int Id;public java.sql.Timestamp Timekey;public String Name;public Course PartOf;public int Duration;public CourseElementType Type;public boolean Required;
	}
...
@Override
	...
	public void setPartOf(Course value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_partOf, value._id) == 0) return;
		changed_partOf = true;
	...
	public void setType(CourseElementType value) {
		...
		if (de.fu.bakery.orm.java.GenericRelationManager.compareValues(ref_type, value._id) == 0) return;
		changed_type = true;
		ref_type = value._id;
		fetched_type = true;
		_type = value;
