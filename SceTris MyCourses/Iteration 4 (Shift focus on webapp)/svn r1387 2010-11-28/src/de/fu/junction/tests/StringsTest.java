...
public class StringsTest {
	...
	public void testArray() {
		...
		assertEquals("a:b", S.implode(":", array));
	}
	...
	public void testEmptyArray() {
		...
		assertEquals("", S.implode("supercalifragilistcexpialidocious", array));
	}

	@Test
	public void testEmptyMap() {
		Map<?,?> map = new HashMap<Object,Object>();
		assertEquals("", S.implode("\n", "supercalifragilistcexpialidocious", map));
	}
	...
	public void testIterable() {
		...
		list.add('a');
		list.add('b');
		assertEquals("a:b", S.implode(":", list));
	}
	...
	public void testMap() {
		...
		map.put(1, Math.PI);
		map.put(2, Math.E);
		assertEquals("0,0.0;1,3.141592653589793;2,2.718281828459045", S.implode(";", ",", map));
	}
