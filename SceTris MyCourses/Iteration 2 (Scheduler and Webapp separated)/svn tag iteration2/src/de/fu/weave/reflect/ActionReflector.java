...
public class ActionReflector<M extends Module<? extends RelationManager>> {
	 ...
	 * @since Iteration2
	 */
	public void invokeCommitAction(final M obj, final String[] args) throws IllegalAccessException,
			InvocationTargetException {
		commitMethod.invoke(obj, new Object[] { args });
	}
