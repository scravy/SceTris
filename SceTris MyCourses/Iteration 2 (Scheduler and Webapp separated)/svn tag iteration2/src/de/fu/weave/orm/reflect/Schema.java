...
public class Schema {
	...
	public Schema(final Document definition) {
		NodeList xmlEntities = definition.getElementsByTagNameNS(XMLNS_ENTL, "entity");
		NodeList xmlRelationships = definition.getElementsByTagNameNS(XMLNS_ENTL, "relationship");
