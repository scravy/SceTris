...
<xsl:template mode="content" match="vars:meta">
	...
	<form method="get" action="{@module-path}/buildinglist/">
	...
	<table cellpadding="5px">
		<tr>
		<th>Edit</th><th>Delete</th><th>Building</th><th>Address</th>
		</tr>
...
<xsl:template match="item:data">
	...
	<td align="center" style="padding-bottom:7px;">
		<a href="{/vars:meta/@module-path}/buildingedit/?data={@id}" class="list edit">⚒</a>
	</td>
	<td align="center">
		<a href="{/vars:meta/@module-path}/buildingvalidate/?data={@id}&amp;crud=delete" class="list delete">×</a>
		</td>
	<td>
