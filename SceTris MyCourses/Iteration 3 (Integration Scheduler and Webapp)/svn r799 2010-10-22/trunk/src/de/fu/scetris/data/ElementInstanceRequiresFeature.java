/* ElementInstanceRequiresFeature.java / 2010-10-22+02:00
...
public class ElementInstanceRequiresFeature extends de.fu.weave.orm.GenericRelationship {
	...
	public void create() throws de.fu.weave.orm.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"elementInstanceRequiresFeature\"" + " (CourseElementInstance, Feature, , \"priority\", \"quantity_min\", \"quantity_better\")"
			+ " VALUES (?, ?, ?);";
		try {
