...
public class Person extends de.fu.weave.orm.GenericEntity implements Comparable<de.fu.weave.orm.Entity>, de.fu.weave.User {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedFirstName() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedAdditionalNames() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedLastName() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedEmailAddress() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedLoginPassword() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedIsSuperuser() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedDeletedBy() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedWorkingHours() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedStudentId() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedStaffId() {
