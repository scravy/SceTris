/* CourseElement.java / 2010-10-22+02:00
...
public class CourseElement extends de.fu.weave.orm.GenericEntity implements Comparable<de.fu.weave.orm.Entity> {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedPartOf() {
