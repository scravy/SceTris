/* CourseElementInstance.java / 2010-10-22+02:00
...
public class CourseElementInstance extends de.fu.weave.orm.GenericEntity implements Comparable<de.fu.weave.orm.Entity> {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedCourseInstance() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedStartingTimeslot() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedDuration() {
	 ...
	 * @return true if the resource has been changed since the last commit
	 */
	public boolean isChangedSchedulableLesson() {
