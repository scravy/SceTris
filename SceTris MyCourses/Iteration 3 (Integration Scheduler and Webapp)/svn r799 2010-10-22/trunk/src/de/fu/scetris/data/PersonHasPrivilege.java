/* PersonHasPrivilege.java / 2010-10-22+02:00
...
public class PersonHasPrivilege extends de.fu.weave.orm.GenericRelationship {
	...
	public void create() throws de.fu.weave.orm.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"personHasPrivilege\"" + " (Person, Privilege, , \"ctime\", \"mtime\", \"created_by\", \"target\", \"because_of_role\")"
			+ " VALUES (?, ?, ?, ?, ?);";
		try {
