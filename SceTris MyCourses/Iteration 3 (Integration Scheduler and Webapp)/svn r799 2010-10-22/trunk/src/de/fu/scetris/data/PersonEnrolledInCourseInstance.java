/* PersonEnrolledInCourseInstance.java / 2010-10-22+02:00
...
public class PersonEnrolledInCourseInstance extends de.fu.weave.orm.GenericRelationship {
	...
	public void create() throws de.fu.weave.orm.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"personEnrolledInCourseInstance\"" + " (Person, CourseInstance, , \"ctime\", \"mtime\", \"created_by\")"
			+ " VALUES (?, ?, ?);";
		try {
