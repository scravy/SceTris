/* PersonTakesPartInElementInstance.java / 2010-10-22+02:00
...
public class PersonTakesPartInElementInstance extends de.fu.weave.orm.GenericRelationship {
	...
	public void create() throws de.fu.weave.orm.DatabaseException {
		String query = "INSERT INTO " + "\"scetris\".\"personTakesPartInElementInstance\"" + " (Person, CourseElementInstance, , \"timeslot\")"
			+ " VALUES (?);";
		try {
