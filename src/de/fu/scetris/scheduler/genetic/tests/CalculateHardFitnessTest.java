...
public class CalculateHardFitnessTest extends SchedulerTest {
    ...
    @Test
    public void testBaseCase() throws SchedulingException {
        ...
        calc.calculateHardFitness(schedule, schedule.getScore());
        ...
        Assert.assertEquals(1, schedule.getScore().getCourseConflictsRoom()
                .size());
        Assert.assertEquals(1, schedule.getScore()
                .getCourseConflictsLecturer().size());
        Assert.assertEquals(2, schedule.getScore()
                .getCourseConflictsLecturer().get(personList.get(1)).size());
    }
    ...
    public void testCourseElementInstancePrefersRoom() throws DatabaseException, SchedulingException {
        ...
        Assert.assertEquals(2, schedule.getScore().getNumberOfHardConstraintsSatisfied());
        ...
        Assert.assertEquals(3, schedule.getScore().getNumberOfHardConstraints());
        Assert.assertEquals(3, schedule.getScore().getNumberOfHardConstraintsSatisfied());
    ...
    public void testFeatureRequirementCases() throws DatabaseException, SchedulingException {
        ...
        Assert.assertEquals(3, schedule.getScore().getNumberOfHardConstraints());
        Assert.assertEquals(3, schedule.getScore()
                .getNumberOfHardConstraintsSatisfied());
    ...
    public void testRoomPrefersTimeSlot() throws SchedulingException, DatabaseException {
        ...
        relationManager.createRoomPrefersTimeslot(roomList.get(0), timeSlotList.get(0), 100);
        schedule.addCourse(courseElementInstanceList.get(0), 1, 0);
        calc.calculateHardFitness(schedule, schedule.getScore());
    ...
    @Test
    public void testYearConstraint() throws SchedulingException, DatabaseException {

        List<CourseRecommendedForYear> courseRecommendedForYearList = new ArrayList<CourseRecommendedForYear>();

        courseRecommendedForYearList.add(relationManager.createCourseRecommendedForYear(
                courseList.get(0), year));

        courseRecommendedForYearList.add(relationManager.createCourseRecommendedForYear(
                courseList.get(1), year));

        configuration = new Configuration(roomList, personList,
                courseElementInstanceList, timeSlotList, featureList,
                new ArrayList<ProposedScheduling>(), courseRecommendedForYearList);
        ...
        Assert.assertEquals(6, schedule.getScore().getNumberOfHardConstraints());
        Assert.assertEquals(4, schedule.getScore().getNumberOfHardConstraintsSatisfied());
        Assert.assertEquals(2, schedule.getScore().getCourseConflictsYearConstraint().size());
        ...
        Assert.assertEquals(6, schedule.getScore().getNumberOfHardConstraints());
        Assert.assertEquals(6, schedule.getScore().getNumberOfHardConstraintsSatisfied());
        Assert.assertEquals(0, schedule.getScore().getCourseConflictsYearConstraint().size());

        relationManager.deleteCourseRecommendedForYear();
    }
}
