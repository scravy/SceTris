/* ElementInstancePrefersRoom.java / 2011-03-03+01:00
...
@de.fu.weave.orm.annotation.Relation(name = "\"scetris\".\"elementInstancePrefersRoom\"", requiredSqlCols = {"priority"})
...
public class ElementInstancePrefersRoom extends de.fu.weave.orm.GenericRelationship {
	...
	ElementInstancePrefersRoom(RelationManager manager, java.sql.ResultSet result) throws de.fu.weave.orm.DatabaseException {
		this.manager = manager;
		timekey(true);
		try {
	...
	@Override
	public ElementInstancePrefersRoom create() throws de.fu.weave.orm.DatabaseException {
	...
	public void pushChanges() throws de.fu.weave.orm.DatabaseException {
		...
		try {
			...
			if (rowsUpdated == 0) {
				throw new de.fu.weave.orm.OutdatedRecordException("\"scetris\".\"elementInstancePrefersRoom\"" + '#' + id());
			}
			_timekey = newTimekey;
		} catch (java.sql.SQLException e) {
			throw new de.fu.weave.orm.DatabaseException(query, e);
	 ...
	 * @since Iteration2
	 */
	public ElementInstancePrefersRoom setElementInstance(CourseElementInstance value) {
	 ...
	 * @since Iteration2
	 */
	public ElementInstancePrefersRoom setRoom(Room value) {
		if (manager.isNull(value)) {
	 ...
	 * @since Iteration2
	 */
	public ElementInstancePrefersRoom setPriority(int value) {
		if (manager.isNull(value)) {
